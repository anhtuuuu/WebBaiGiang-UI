...
<!-- Mirrored from studyglance.in/labprograms/ppsdisplay.php?url1=PPS/Quadratic-equation-c-program.html&title=Write%20a%20C%20program%20to%20find%20the%20roots%20of%20a%20Quadratic%20equation. by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:48:25 GMT -->
...
<h1>Write a C program to find the roots of a Quadratic equation.</h1>
<h4>The standard form of a quadratic equation is: ax<sup>2</sup> + bx + c = 0, where
a, b and c are real numbers
<br>The term b<sup>2</sup> - 4ac is known as the discriminant of a quadratic equation. It tells the nature of the roots.
<br><font size="5" color="#AC3B61">&#x261B;</font>&nbsp;&nbsp;If the discriminant is greater than 0, the roots are real and different.
<br><font size="5" color="#AC3B61">&#x261B;</font>&nbsp;&nbsp;If the discriminant is equal to 0, the roots are real and equal.
<br><font size="5" color="#AC3B61">&#x261B;</font>&nbsp;&nbsp;If the discriminant is less than 0, the roots are complex and different.</h4>


<div class="row"> 
<div class="col-md-12">
<div class="alert alert-info"><b>Algorithm</b> <pre><code class="">
start
	step1: Read a,b,c
	step2: discriminant := b<sup>2</sup> - 4*a*c
	step3: if discriminant > 0 then
	step4:	root1 := (-b + &#8730;<SPAN STYLE="text-decoration:overline">(discriminant)</SPAN>) / (2 * a);
	step5:	root2 := (-b - &#8730;<SPAN STYLE="text-decoration:overline">(discriminant)</SPAN>) / (2 * a);
	...
	step12:    imagPart = &#8730;<SPAN STYLE="text-decoration:overline">(discriminant)</SPAN> / (2 * a);
...
<div class="row"> 
<div class="col-md-12">
<div class="alert alert-info"><b>C Programming</b> <pre><code class="language-c">//to find the roots of a Quadratic equation
...
<div class="row"> 
<div class="col-md-12">
<div class="alert alert-warning"><b>OUTPUT-1</b><pre><code class="language-c">Enter coefficients a, b and c: 1 -2 1
root1 = root2 = 1.00</code></pre>
</div></div></div>
<div class="row"> 
<div class="col-md-12">
<div class="alert alert-warning"><b>OUTPUT-2</b><pre><code class="language-c">Enter coefficients a, b and c: 1 7 12
root1 = -3.00 and root2 = -4.00</code></pre>
</div></div></div>
<div class="row"> 
<div class="col-md-12">
<div class="alert alert-warning"><b>OUTPUT-3</b><pre><code class="language-c">Enter coefficients a, b and c: 5 3 2
root1 = -0.30+0.56i and root2 = -0.30-0.56i</code></pre>
</div></div></div><!--
