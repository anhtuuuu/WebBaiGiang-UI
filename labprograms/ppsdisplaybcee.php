...
<!-- Mirrored from studyglance.in/labprograms/ppsdisplay.php?url1=PPS/x-raised-to-the-power-of-n-c-programm.html&title=Write%20C%20programs%20that%20use%20both%20recursive%20and%20non-recursive%20functions%20to%20find%20x^n by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:48:28 GMT -->
...
<h1>Write C programs that use both recursive and non-recursive functions to find x^n.</h1>
...
<div class="row"> 
<div class="col-md-12">
<div class="alert alert-info"><b>C Programming</b> <pre><code class="language-c">//use both recursive and non-recursive functions to find x^n.
#include &lt;stdio.h>
...
<div class="row"> 
<div class="col-md-12">
<div class="alert alert-warning"><b>OUTPUT</b><pre><code class="language-c">Enter the base (x): 9
Enter the exponent (n): 4
non-recursive function: 9^4 = 6561
recursive function: 9^4 = 6561</code></pre>
</div></div></div><!--
