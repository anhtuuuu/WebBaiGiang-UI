...
<!-- Mirrored from studyglance.in/labprograms/sdcdisplay.php?url1=ai/week2.pl&url2=&url3=&url4=&title=Write%20predicates%20one%20converts%20centigrade%20temperatures%20to%20Fahrenheit,%20the%20other%20checks%20if%20a%20temperature%20is%20below%20freezing.&opurl1=ai/outputs/w2.txt&opurl2=&opurl3=&opurl4= by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:48:56 GMT -->
...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <h1 style="font-size:22px;color:black;">Write predicates one converts centigrade temperatures to Fahrenheit, the other checks if a temperature is below freezing. </h1>
  <h2>Solution : </h2>
  <!--<h3>week2.pl</h3>-->
<pre><code class="language-prolog"><xmp>% Production rules:
