...
<h2>Aim: </h2>
  <h1 style="font-size:18px;color:black;">Write a program that uses functions to perform the following operations on circular linkedlist.: <BR>i) Creation      ii) Insertion      iii) Deletion      iv) Traversal </h1>
  <h2>Solution : </h2>	

 <h1>C Program to implement Circular Linked List</h1>
<div class="row"> 
	<div class="col-md-12">
		<div class="alert alert-info"><b>Circular Linked List</b><pre><code class="language-c">#include&lt;stdio.h>
#include&lt;stdlib.h>
...
7.Display
8.Exit
Enter your choice: 8</code></pre></div>
	</div>
</div>
