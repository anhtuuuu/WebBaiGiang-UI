...
<!-- Mirrored from studyglance.in/labprograms/javadisplay.php?url1=java/FirstApplet.java&url2=&url3=&url4=&title=a)%20Develop%20an%20applet%20in%20Java%20that%20displays%20a%20simple%20message.&alg=&opurl1=java/outputs/w3a1.png&opurl2=java/outputs/w3a2.png&opurl3=&opurl4=&opurl5= by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:48:32 GMT -->
...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <h1 style=" text-align: justify;"> a) Develop an applet in Java that displays a simple message. </h1>
  <!--<h2> Algorithm </h2>
  <pre></pre>-->
  <h2>Source Code: </h2>
  <h3>FirstApplet.java</h3>
<pre><code class="language-java"><code><span style="color: #000000">
/*&nbsp;Develop&nbsp;a&nbsp;applet&nbsp;to&nbsp;display&nbsp;the&nbsp;simple&nbsp;message&nbsp;*/<br />import&nbsp;java.awt.*;<br />import&nbsp;java.applet.*;<br />/*&lt;applet&nbsp;code="FirstApplet"&nbsp;width=400&nbsp;height=300&gt;&lt;/applet&gt;*/<br />public&nbsp;class&nbsp;FirstApplet&nbsp;extends&nbsp;Applet&nbsp;{<br />public&nbsp;void&nbsp;paint(Graphics&nbsp;g)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;g.setColor(Color.blue);&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;Font&nbsp;font&nbsp;=&nbsp;new&nbsp;Font("Arial",&nbsp;Font.BOLD,&nbsp;16);&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;g.setFont(font);&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;g.drawString("This&nbsp;is&nbsp;My&nbsp;First&nbsp;Applet",60,110);<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br />}<br /><br /></span>
</code></code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="java/outputs/w3a1.png" alt="image" class="img-rounded img-responsive"/><br/>
<img src="java/outputs/w3a2.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
