...
<!-- Mirrored from studyglance.in/labprograms/pythondisplay.php?url1=python/week19.py&url2=&url3=&url4=&title=Write%20a%20Python%20class%20to%20implement%20pow(x,%20n)&opurl1=python/outputs/w19.png&opurl2=&opurl3=&opurl4= by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:50:49 GMT -->
...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <p>Write a Python class to implement pow(x, n) </p>
  <h2>Source Code: </h2>
  <h3>week19.py</h3>
<pre><code class="language-py"><code><span style="color: #000000">
'''Write&nbsp;a&nbsp;Python&nbsp;class&nbsp;to&nbsp;implement&nbsp;pow(x,&nbsp;n)'''<br />class&nbsp;py_pow:<br />&nbsp;&nbsp;&nbsp;def&nbsp;powr(self,&nbsp;x,&nbsp;n):<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;x==0&nbsp;or&nbsp;x==1&nbsp;or&nbsp;n==1:<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;x&nbsp;<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;x==-1:<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;n%2&nbsp;==0:<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;1<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;else:<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;-1<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;n==0:<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;1<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;n&lt;0:<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;1/self.powr(x,-n)<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;val&nbsp;=&nbsp;self.powr(x,n//2)<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;n%2&nbsp;==0:<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;val*val<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;val*val*x<br /><br />x=int(input("Enter&nbsp;x&nbsp;value&nbsp;:"))<br />n=int(input("Enter&nbsp;n&nbsp;value&nbsp;:"))<br />print("pow(x,n)&nbsp;value&nbsp;is&nbsp;:",py_pow().powr(x,n));<br /></span>
</code></code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="python/outputs/w19.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
...
<!-- Mirrored from studyglance.in/labprograms/pythondisplay.php?url1=python/week19.py&url2=&url3=&url4=&title=Write%20a%20Python%20class%20to%20implement%20pow(x,%20n)&opurl1=python/outputs/w19.png&opurl2=&opurl3=&opurl4= by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:50:50 GMT -->
</html>
