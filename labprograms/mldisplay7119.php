...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <h1 style="font-size:22px;color:black;">Implement the finite words classification system using Back-propagation algorithm</h1>
  <!--<h2> Explanation : </h2>
  <p></p>-->
  <h2>Source Code: </h2>
  <h3>Week9.py</h3>
<pre><code class="language-py">''' Implement the finite words classification system using Back-propagation algorithm
...
-->
<h2>Output: </h2>
<img src="ml/outputs/w91.png" alt="image" class="img-rounded img-responsive"/><br/>
<img src="ml/outputs/w92.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
