...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <p>Write a program that accepts the lengths of three sides of a triangle as inputs. The program output should indicate whether or not the triangle is a right triangle (Recall from the Pythagorean Theorem that in a right triangle, the square of one side equals the sum of the squares of the other two sides). </p>
  <h2>Source Code: </h2>
  <h3>week13.py</h3>
<pre><code class="language-py"><code><span style="color: #000000">
'''Write&nbsp;a&nbsp;program&nbsp;that&nbsp;accepts&nbsp;the&nbsp;lengths&nbsp;of&nbsp;three&nbsp;sides&nbsp;of&nbsp;a&nbsp;triangle&nbsp;as&nbsp;inputs.&nbsp;The<br />program&nbsp;output&nbsp;should&nbsp;indicate&nbsp;whether&nbsp;or&nbsp;not&nbsp;the&nbsp;triangle&nbsp;is&nbsp;a&nbsp;right&nbsp;triangle&nbsp;(Recall<br />from&nbsp;the&nbsp;Pythagorean&nbsp;Theorem&nbsp;that&nbsp;in&nbsp;a&nbsp;right&nbsp;triangle,&nbsp;the&nbsp;square&nbsp;of&nbsp;one&nbsp;side&nbsp;equals<br />the&nbsp;sum&nbsp;of&nbsp;the&nbsp;squares&nbsp;of&nbsp;the&nbsp;other&nbsp;two&nbsp;sides).'''<br />base=float(input("Enter&nbsp;length&nbsp;of&nbsp;Base&nbsp;:&nbsp;"))<br />perp=float(input("Enter&nbsp;length&nbsp;of&nbsp;Perpendicular&nbsp;:&nbsp;"))<br />hypo=float(input("Enter&nbsp;length&nbsp;of&nbsp;Hypotenuse&nbsp;:&nbsp;"))<br /><br />if&nbsp;hypo**2==((base**2)+(perp**2)):<br />&nbsp;&nbsp;&nbsp;&nbsp;print("It's&nbsp;a&nbsp;right&nbsp;triangle")<br />else:<br />&nbsp;&nbsp;&nbsp;&nbsp;print("It's&nbsp;not&nbsp;a&nbsp;right&nbsp;triangle")<br />&nbsp;&nbsp;&nbsp;&nbsp;</span>
</code></code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="python/outputs/w13.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
