...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <p>Write a program that implement Queue (its operations) using Arrays            </p>
  <h2>Source Code: </h2>
  <h3>queuearr.c</h3>
<pre><code class="language-c"><code><span style="color: #000000">
#include&lt;stdio.h&gt;<br />#include&lt;conio.h&gt;<br />#define&nbsp;SIZE&nbsp;5<br /><br />int&nbsp;queue[SIZE],&nbsp;front&nbsp;=&nbsp;-1,&nbsp;rear&nbsp;=&nbsp;-1;<br />void&nbsp;enQueue(int&nbsp;value){<br /><br />if(rear&nbsp;==&nbsp;SIZE-1)<br />printf("\nQueue&nbsp;is&nbsp;Full!!!&nbsp;Insertion&nbsp;is&nbsp;not&nbsp;possible!!!");<br />else{<br />if(front&nbsp;==&nbsp;-1)<br />front&nbsp;=&nbsp;0;<br />rear++;<br />queue[rear]&nbsp;=&nbsp;value;<br />printf("\nInsertion&nbsp;success!!!");<br />}<br />}<br />void&nbsp;deQueue(){<br />if(front&nbsp;==&nbsp;rear)<br />printf("\nQueue&nbsp;is&nbsp;Empty!!!&nbsp;Deletion&nbsp;is&nbsp;not&nbsp;possible!!!");<br />else{<br />printf("\nDeleted&nbsp;:&nbsp;%d",&nbsp;queue[front]);<br />front++;<br />if(front&nbsp;==&nbsp;rear)<br />front&nbsp;=&nbsp;rear&nbsp;=&nbsp;-1;<br />}<br />}<br />void&nbsp;display(){<br />if(rear&nbsp;==&nbsp;-1)<br />printf("\nQueue&nbsp;is&nbsp;Empty!!!");<br />else{<br />int&nbsp;i;<br />printf("\nQueue&nbsp;elements&nbsp;are:\n");<br />for(i=front;&nbsp;i&lt;=rear;&nbsp;i++)<br />printf("%d\t",queue[i]);<br />}<br />}<br /><br />void&nbsp;main()<br />{<br />int&nbsp;value,&nbsp;choice;<br />while(1){<br />printf("\n\n*****&nbsp;MENU&nbsp;*****\n");<br />printf("1.&nbsp;Insertion\n2.&nbsp;Deletion\n3.&nbsp;Display\n4.&nbsp;Exit");<br />printf("\nEnter&nbsp;your&nbsp;choice:&nbsp;");<br />scanf("%d",&amp;choice);<br />switch(choice){<br />case&nbsp;1:&nbsp;printf("Enter&nbsp;the&nbsp;value&nbsp;to&nbsp;be&nbsp;insert:&nbsp;");<br />scanf("%d",&amp;value);<br />enQueue(value);<br />break;<br />case&nbsp;2:&nbsp;deQueue();<br />break;<br />case&nbsp;3:&nbsp;display();<br />break;<br />case&nbsp;4:&nbsp;exit(0);<br />default:&nbsp;printf("\nWrong&nbsp;selection!!!&nbsp;Try&nbsp;again!!!");&nbsp;&nbsp;<br />}&nbsp;<br />}&nbsp;<br />}</span>
</code></code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="ds/outputs/queuea.png" alt="image" class="img-rounded img-responsive"/><br/>
<img src="ds/outputs/queueb.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
