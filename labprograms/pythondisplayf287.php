...
<!-- Mirrored from studyglance.in/labprograms/pythondisplay.php?url1=python/file1.txt&url2=python/week16.py&url3=&url4=&title=Write%20a%20script%20named%20copyfile.py.%20This%20script%20should%20prompt%20the%20user%20for%20the%20names%20of%20two%20text%20files.%20The%20contents%20of%20the%20first%20file%20should%20be%20input%20and%20written%20to%20the%20second%20file.&opurl1=python/outputs/w16.png&opurl2=&opurl3=&opurl4= by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:50:48 GMT -->
...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <p>Write a script named copyfile.py. This script should prompt the user for the names of two text files. The contents of the first file should be input and written to the second file. </p>
  <h2>Source Code: </h2>
  <h3>file1.txt</h3>
<pre><code class="language-txt"><code><span style="color: #000000">
This&nbsp;is&nbsp;python&nbsp;program<br />welcome&nbsp;to&nbsp;python</span>
</code></code></pre><br>
 <h3>week16.py</h3>
<pre><code class="language-py"><code><span style="color: #000000">
'''Write&nbsp;a&nbsp;script&nbsp;named&nbsp;copyfile.py.&nbsp;This&nbsp;script&nbsp;should&nbsp;prompt&nbsp;the&nbsp;user&nbsp;for&nbsp;the&nbsp;names&nbsp;of&nbsp;two&nbsp;text&nbsp;files.&nbsp;The&nbsp;contents&nbsp;of&nbsp;the&nbsp;first&nbsp;file&nbsp;should&nbsp;be&nbsp;input&nbsp;and&nbsp;written&nbsp;to&nbsp;the&nbsp;second<br />file'''<br />file1=input("Enter&nbsp;First&nbsp;Filename&nbsp;:&nbsp;")<br />file2=input("Enter&nbsp;Second&nbsp;Filename&nbsp;:&nbsp;")<br />#&nbsp;open&nbsp;file&nbsp;in&nbsp;read&nbsp;mode&nbsp;<br />fn1&nbsp;=&nbsp;open(file1,&nbsp;'r')&nbsp;<br /><br />#&nbsp;open&nbsp;other&nbsp;file&nbsp;in&nbsp;write&nbsp;mode&nbsp;<br />fn2&nbsp;=&nbsp;open(file2,&nbsp;'w')&nbsp;<br /><br />#&nbsp;read&nbsp;the&nbsp;content&nbsp;of&nbsp;the&nbsp;file&nbsp;line&nbsp;by&nbsp;line&nbsp;<br />cont&nbsp;=&nbsp;fn1.readlines()&nbsp;<br />#type(cont)&nbsp;<br />for&nbsp;i&nbsp;in&nbsp;range(0,&nbsp;len(cont)):<br />&nbsp;&nbsp;&nbsp;&nbsp;fn2.write(cont[i])&nbsp;<br /><br />#&nbsp;close&nbsp;the&nbsp;file&nbsp;<br />fn2.close()&nbsp;<br />print("Content&nbsp;of&nbsp;first&nbsp;file&nbsp;copied&nbsp;to&nbsp;second&nbsp;file&nbsp;")<br /><br />#&nbsp;open&nbsp;file&nbsp;in&nbsp;read&nbsp;mode&nbsp;<br />fn2&nbsp;=&nbsp;open(file2,&nbsp;'r')&nbsp;<br />&nbsp;&nbsp;<br />#&nbsp;read&nbsp;the&nbsp;content&nbsp;of&nbsp;the&nbsp;file&nbsp;<br />cont1&nbsp;=&nbsp;fn2.read()&nbsp;<br />&nbsp;&nbsp;<br />#&nbsp;print&nbsp;the&nbsp;content&nbsp;of&nbsp;the&nbsp;file&nbsp;<br />print("Content&nbsp;of&nbsp;Second&nbsp;file&nbsp;:")<br />print(cont1)&nbsp;<br />&nbsp;&nbsp;<br />#&nbsp;close&nbsp;all&nbsp;files&nbsp;<br />fn1.close()&nbsp;<br />fn2.close()&nbsp;</span>
</code></code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="python/outputs/w16.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
