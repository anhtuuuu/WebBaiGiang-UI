...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <p>Write a python program to define a module and import a specific function in that module to another program. </p>
  <h2>Source Code: </h2>
  <h3>arth.py</h3>
...
'''&nbsp;Arithmetic&nbsp;Operations&nbsp;Module&nbsp;with&nbsp;Multiple&nbsp;functions'''<br />def&nbsp;Add(a,b):<br />&nbsp;&nbsp;&nbsp;&nbsp;c=a+b<br />&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;c<br />def&nbsp;Sub(a,b):<br />&nbsp;&nbsp;&nbsp;&nbsp;c=a-b<br />&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;c<br />def&nbsp;Mul(a,b):<br />&nbsp;&nbsp;&nbsp;&nbsp;c=a*b<br />&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;c</span>
 ...
 <h3>week15.py</h3>
<pre><code class="language-py"><code><span style="color: #000000">
'''Write&nbsp;a&nbsp;python&nbsp;program&nbsp;to&nbsp;define&nbsp;a&nbsp;module&nbsp;and&nbsp;import&nbsp;a&nbsp;specific&nbsp;function&nbsp;in&nbsp;that<br />module&nbsp;to&nbsp;another&nbsp;program.'''<br />from&nbsp;arth&nbsp;import&nbsp;Add<br />num1=float(input("Enter&nbsp;first&nbsp;Number&nbsp;:&nbsp;"))<br />num2=float(input("Enter&nbsp;second&nbsp;Number&nbsp;:&nbsp;"))<br />print("Addition&nbsp;is&nbsp;:&nbsp;",Add(num1,num2))<br />print("Subtraction&nbsp;is&nbsp;:&nbsp;",Sub(num1,num2))&nbsp;#gives&nbsp;error:Not&nbsp;importing&nbsp;Sub&nbsp;function&nbsp;from&nbsp;arth&nbsp;Module</span>
</code></code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="python/outputs/w15.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
