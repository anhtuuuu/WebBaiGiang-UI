...
<!-- Mirrored from studyglance.in/labprograms/ppsdisplay.php?url1=PPS/fractional-sequence-c-program.html&title=Write%20a%20C%20program%20to%20calculate%20the%20following,%20where%20x%20is%20a%20fractional%20value.i.%201-x/2%20+x^2/4-x^3/6 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:48:25 GMT -->
...
<h1>Write a C program to calculate the following, where x is a fractional value.i. 1-x/2 +x^2/4-x^3/6......</h1>
...
start
	...
	step5:     term := 1
	step6: 	else term := -1
	step7: 	term := term * (x<sup>i</sup> / 2*i)
...
<img src="PPS/images/fractional-sequence.jpg" width="70%" alt="flowchart for fractional sequence in c">
</pre>
</div>
</div></div>
<br>
...
<div class="row"> 
<div class="col-md-12">
<div class="alert alert-info"><b>C Programming</b> <pre><code class="language-c">//1-x/2 +x^2/4-x^3/6......
#include &lt;stdio.h>
#include &lt;math.h>
...
<div class="row"> 
<div class="col-md-12">
<div class="alert alert-warning"><b>OUTPUT</b><pre><code class="language-c">Enter a fractional value for x: 2
Enter the number of terms (n): 3
The result of the expression is: -0.333333</code></pre>
</div></div></div><!--
