...
<!-- Mirrored from studyglance.in/labprograms/ppsdisplay.php?url1=PPS/string-palindrome-or-not-c-program.html&title=Write%20a%20C%20program%20to%20determine%20if%20the%20given%20string%20is%20a%20palindrome%20or%20not%20(Spelled%20same%20in%20both%20directions%20with%20or%20without%20a%20meaning%20like%20madam,%20civic,%20noon,%20abcba,%20etc.) by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:48:29 GMT -->
...
<h1>Write a C program to determine if the given string is a palindrome or not (Spelled same in both directions with or without a meaning like madam, civic, noon, abcba, etc.).</h1>

<div class="row"> 
<div class="col-md-12">
<div class="alert alert-info"><b>C Program</b> <pre><code class="language-c">//to find the given string is a palindrome or not.
#include &lt;stdio.h>
#include &lt;string.h>
...
<div class="row"> 
<div class="col-md-12">
<div class="alert alert-warning"><b>OUTPUT-1</b><pre><code class="language-c">Enter a string: madam
...
<div class="row"> 
<div class="col-md-12">
<div class="alert alert-warning"><b>OUTPUT-2</b><pre><code class="language-c">Enter a string: abcdba
