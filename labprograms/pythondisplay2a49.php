...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <p>Write a python program to define a module to find Fibonacci Numbers and import the module to another program.  </p>
  <h2>Source Code: </h2>
  <h3>fibonacci.py</h3>
<pre><code class="language-py"><code><span style="color: #000000">
#&nbsp;Fibonacci&nbsp;numbers&nbsp;module<br /><br />def&nbsp;fib(n):&nbsp;&nbsp;&nbsp;&nbsp;#&nbsp;write&nbsp;Fibonacci&nbsp;series&nbsp;up&nbsp;to&nbsp;n<br />&nbsp;&nbsp;&nbsp;&nbsp;a,&nbsp;b&nbsp;=&nbsp;0,&nbsp;1<br />&nbsp;&nbsp;&nbsp;&nbsp;while&nbsp;b&nbsp;&lt;&nbsp;n:<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;print(b,&nbsp;end&nbsp;="&nbsp;")<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;a,&nbsp;b&nbsp;=&nbsp;b,&nbsp;a+b</span>
</code></code></pre><br>
 <h3>week14.py</h3>
<pre><code class="language-py"><code><span style="color: #000000">
'''Write&nbsp;a&nbsp;python&nbsp;program&nbsp;to&nbsp;define&nbsp;a&nbsp;module&nbsp;to&nbsp;find&nbsp;Fibonacci&nbsp;Numbers&nbsp;and&nbsp;import&nbsp;the<br />module&nbsp;to&nbsp;another&nbsp;program'''<br />#import&nbsp;fibonacci&nbsp;module<br />import&nbsp;fibonacci&nbsp;<br />num=int(input("Enter&nbsp;any&nbsp;number&nbsp;to&nbsp;print&nbsp;Fibonacci&nbsp;series&nbsp;"))<br />fibonacci.fib(num)</span>
</code></code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="python/outputs/w14.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
