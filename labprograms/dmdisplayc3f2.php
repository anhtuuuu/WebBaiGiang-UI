...
<!-- Mirrored from studyglance.in/labprograms/dmdisplay.php?url1=dm/loadingdataweka.html&title=Loading%20Data%20from%20different%20sources%20in%20WEKA. by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:49:05 GMT -->
...
<h2>Aim: </h2>
  <h1 style="font-size:18px;color:black;"><span style='font-size:25px;color:#ff3333;'>&#9755;</span> &nbsp;Loading Data from different sources in WEKA. </h1>
  <h2>Solution : </h2>	
...
<html lang="en">
 <head>
  ...
  <title>Loading Data from different sources in WEKA </title>
   <style>
  p {
  color:black;
  }
 ...
 <body>
     <h1>Loading Data from different sources in WEKA :</h1>
<p>In order to utilize Weka Explorer, it is essential to start by loading the data into the application.<br/>
<br/>
Multiple sources are available for data loading within Weka Explorer.Those are,
</p><br>
<p>
<ol style="font-weight:bold;font-color:black;">
<li> Local file system</li>
<li> Web</li>
<li> Database</li>
<li> Generate Artificial Data</li>
</ol>
</p>
<br>
<p>The diagram presented below provides a concise summary of the offerings provided by WEKA.</p><br>
	<div class="row"> 
		<div class="col-md-12">
		<img src="dm/images/Weka30.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
		<div class="col-md-4">	
		&nbsp;
		</div>
	</div>
<h2><font color="#000099">1. Loading data from Local file System: </font></h2>
<p>
In this, we are going to load data from the Local File System by clicking on the <strong>Open file...</strong> button.
<h3><u>Steps:</u></h3>
<ul style="font-color:black;">
<li><p> Click on <strong>Open file...</strong> button.</p> </li>
<li><p> <strong>Navigate the folder,</strong> where the data files are stored.</p></li>
<li><p> Select the <strong>required data file.</strong></p></li>
...
<br>
	<div class="row"> 
		<div class="col-md-12">
		<img src="dm/images/Weka31.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
		<div class="col-md-4">	
		&nbsp;
		</div>
...
<h2><font color="#000099">2. Loading data from Web: </font></h2>
<p>
In this, we are going to load data from the Web by clicking on the <strong>Open URL...</strong> button.
<h3><u>Steps:</u></h3>
<ul style="font-color:black;">
<li><p> Click on <strong>Open URL...</strong> button.</p> </li>
<li><p> <strong> Enter the URL</strong> of data source in the popup box.</p></li>
...
<br>
	<div class="row"> 
		<div class="col-md-12">
		<img src="dm/images/Weka32.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
		<div class="col-md-4">	
		&nbsp;
		</div>
...
<p>
Example public <strong>Data source URLs</strong> are:<br><br>
<ul>
<li>https://storm.cis.fordham.edu/~gweiss/data-mining/weka-data/weather.nominal.arff</li>
<li>https://storm.cis.fordham.edu/~gweiss/data-mining/weka-data/iris.arff</li>
<li>https://storm.cis.fordham.edu/~gweiss/data-mining/weka-data/vote.arff</li>
</ul>
</p><br>
<h2><font color="#000099">3. Loading data from Database: </font></h2>
<p>
In this, we are going to load data from the Database by clicking on the <strong>Open DB...</strong> button.
<h3><u>Steps:</u></h3>
<ul style="font-color:black;">
<li><p> Click on <strong>Open DB...</strong> button.</p> </li>
<li><p> Enter the <strong>Connection URL</strong> of database.</p></li>
<li><p>Type <strong>SQL Query</strong> to get data from Database table.</p></li>
<li><p> Click on <strong>Ok</strong> button.</p></li>
</ul>
</p>
<br>
	<div class="row"> 
		<div class="col-md-12">
		<img src="dm/images/Weka33.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
		<div class="col-md-4">	
		&nbsp;
		</div>
	</div>
<h2><font color="#000099">4. Generate Artificial Data: </font></h2>
<p>
In this, the artificial data (random data) will be generated by clicking on the <strong>Generate...</strong> button.
<h3><u>Steps:</u></h3>
<ul style="font-color:black;">
<li><p> Click on <strong>Generate...</strong> button.</p> </li>
<li><p> <strong>Choose Data Generator</strong>.</p></li>
<li><p> Click on <strong>Generate</strong> button.</p></li>
</ul>
</p>
<br>
	<div class="row"> 
		<div class="col-md-12">
		<img src="dm/images/Weka34.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
		<div class="col-md-4">	
		&nbsp;
		</div>
...
<!-- Mirrored from studyglance.in/labprograms/dmdisplay.php?url1=dm/loadingdataweka.html&title=Loading%20Data%20from%20different%20sources%20in%20WEKA. by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:49:07 GMT -->
</html>
