...
<!-- Mirrored from studyglance.in/labprograms/dmdisplay.php?url1=dm/wekainstallation.html&title=Downloading%20and/or%20installation%20of%20WEKA%20Data%20Mining%20toolkit. by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:48:56 GMT -->
...
<h2>Aim: </h2>
  <h1 style="font-size:18px;color:black;"><span style='font-size:25px;color:#ff3333;'>&#9755;</span> &nbsp;Downloading and/or installation of WEKA Data Mining toolkit. </h1>
  <h2>Solution : </h2>	
...
<html lang="en">
 <head>
  ...
  <title>Downloading and/or installation of WEKA data mining toolkit</title>
   <style>
  p {
  color:black;
  }
 ...
 <body>
  <h1> Installation Steps for WEKA Data Mining Tool </h1><br>
  <p> 1.  <strong>Download the software</strong>(Weka Tool Kit) as your requirements from the below given link.<br><br>
	<a href="http://www.cs.waikato.ac.nz/ml/weka/downloading.html" target="_blank" style="font-weight:bold;" class="alab">http://www.cs.waikato.ac.nz/ml/weka/downloading.html</a></p><br>
	<p> 2. The <strong>Java is mandatory</strong> for installation of WEKA so if you have already Java on yourmachine then download only WEKA else download the software with JVM.</p>
	<br>
	<p>3. Then open the file location and <strong>double click </strong>on the file. Click on <strong>Run</strong>.</p><br>

	<div class="row"> 
		<div class="col-md-7">
		<img src="dm/images/Weka0.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
		<div class="col-md-4">	
		&nbsp;
		</div>
	</div>
	<p> 4. Click <strong>Next</strong> to continue.</p><br>
	<div class="row"> 
		<div class="col-md-7">
		<img src="dm/images/Weka1.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
		<div class="col-md-4">	
		&nbsp;
		</div>
	</div>
	<p> 5. If you accept the terms of the agreement, click <strong>I Agree</strong> to continue. You must accept the agreement to install Weka.</p><br>
	<div class="row"> 
		<div class="col-md-7">
		<img src="dm/images/Weka2.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
		<div class="col-md-4">	
		&nbsp;
		</div>
	</div>
	<p> 6. Check the components you want to install and uncheck the components you do not want to install. Click <strong>Next</strong> to continue. </p><br>
	<div class="row"> 
		<div class="col-md-7">
		<img src="dm/images/Weka3.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
		<div class="col-md-4">	
		&nbsp;
		</div>
	</div>
	<p> 7. Setup will install Weka 3.8.6 in the following folder. To install in a different folder, click Browse and select another folder. Click <strong>Next</strong> to continue. </p><br>
	<div class="row"> 
		<div class="col-md-7">
		<img src="dm/images/Weka4.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
		<div class="col-md-4">	
		&nbsp;
		</div>
	</div>
	<p> 8. Choose a Start Menu folder in which you would like to create the Weka 3.8.6 shortcuts. You can also enter a name to create a new folder. And then click on <strong>Install</strong> to continue. </p><br>
	<div class="row"> 
	<div class="col-md-7">
		<img src="dm/images/Weka5.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
		<div class="col-md-4">	
		&nbsp;
		</div>
	</div>
	<p> 9.<strong>Installing: </strong>Please wait while Weka 3.8.6 is being installed. </p><br>
		<div class="row"> 
			<div class="col-md-7">
		<img src="dm/images/Weka6.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
			<div class="col-md-4">	
			&nbsp;
			</div>
		</div>
	<p> 10.<strong>Installation Complete:</strong> Setup was completed successfully. Click <strong>Next</strong> to continue. </p><br>
		<div class="row"> 
			<div class="col-md-7">
		<img src="dm/images/Weka7.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
			<div class="col-md-4">	
			&nbsp;
			</div>
		</div>
	<p> 11. Weka 3.8.6 has been installed on your computer. Click <strong>Finish</strong> to close Setup.</p><br>
		<div class="row"> 
			<div class="col-md-7">
		<img src="dm/images/Weka8.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
			<div class="col-md-4">	
			&nbsp;
			</div>
...
<!-- Mirrored from studyglance.in/labprograms/dmdisplay.php?url1=dm/wekainstallation.html&title=Downloading%20and/or%20installation%20of%20WEKA%20Data%20Mining%20toolkit. by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:49:00 GMT -->
</html>
