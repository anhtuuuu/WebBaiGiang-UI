...
<!-- Mirrored from studyglance.in/labprograms/ppsdisplay.php?url1=PPS/Geometric-progression-c-program.html&title=Write%20a%20C%20program%20to%20read%20in%20two%20numbers,%20x%20and%20n,%20and%20then%20compute%20the%20sum%20of%20this%20geometric%20progression:%201+x+x^2+x^3+..............+x^n.%20For%20example:%20if%20n%20is%203%20and%20x%20is%205,%20then%20the%20program%20computes%201+5+25+125. by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:48:25 GMT -->
...
<h1>Write a C program to read in two numbers, x and n, and then compute the sum of this geometric progression: 1+x+x^2+x^3+..............+x^n. For example: if n is 3 and x is 5, then the program computes 1+5+25+125.</h1>
...
start
	step1: sum := 0
	step2: Read x,n
	step3: for i := 0 to n step 1 do
	step4: 	sum := sum + x<sup>i</sup>
	step5: Print sum
stop
</code></pre>
</div></div></div>
...
<img src="PPS/images/Geometric-progression.jpg" width="40%" alt="flowchart for sum of this geometric progression in c">
</pre>
</div>
</div></div>
<br>
...
<div class="row"> 
<div class="col-md-12">
<div class="alert alert-info"><b>C Programming</b> <pre><code class="language-c">//compute the sum of this geometric progression: 1+x+x^2+x^3+..............+x^n
#include &lt;stdio.h>
#include &lt;math.h>
...
<div class="row"> 
<div class="col-md-12">
<div class="alert alert-warning"><b>OUTPUT</b><pre><code class="language-c">Enter the value of x: 4
Enter the value of n: 4
The sum of the geometric progression is: 341</code></pre>
</div></div></div><!--
...
<!-- Mirrored from studyglance.in/labprograms/ppsdisplay.php?url1=PPS/Geometric-progression-c-program.html&title=Write%20a%20C%20program%20to%20read%20in%20two%20numbers,%20x%20and%20n,%20and%20then%20compute%20the%20sum%20of%20this%20geometric%20progression:%201+x+x^2+x^3+..............+x^n.%20For%20example:%20if%20n%20is%203%20and%20x%20is%205,%20then%20the%20program%20computes%201+5+25+125. by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:48:27 GMT -->
</html>
