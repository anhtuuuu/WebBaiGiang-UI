...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <h3><pre style="border:none;font-size:15px;font-color:#000033;"> Write a PHP script that reads data from one file and write into another file.</pre> </h3>
  <!--<h2> Algorithm </h2>
  <pre></pre>-->
  <h2>Source Code: </h2>
  <h3>Week-4/file1.txt</h3>
<pre><code class="language-txt"><code><span style="color: #000000">
PHP&nbsp;allows&nbsp;us&nbsp;to&nbsp;perform&nbsp;various&nbsp;operations&nbsp;on&nbsp;the&nbsp;files.</span>
</code></code></pre><br>
 <h3>Week-4/Week4.php</h3>
<pre><code class="language-php"><code><span style="color: #000000">
&lt;html&gt;<br />&lt;head&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&lt;title&gt;Reads&nbsp;data&nbsp;from&nbsp;one&nbsp;file&nbsp;and&nbsp;write&nbsp;into&nbsp;another&nbsp;file&nbsp;in&nbsp;PHP&lt;/title&gt;<br />&lt;/head&gt;<br />&lt;body&gt;<br /><span style="color: #0000BB">&lt;?php<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;filename&nbsp;to&nbsp;open<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$fname&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #DD0000">"file1.txt"</span><span style="color: #007700">;<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;to&nbsp;open&nbsp;file&nbsp;for&nbsp;reading<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$fptr&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #0000BB">fopen</span><span style="color: #007700">(</span><span style="color: #0000BB">$fname</span><span style="color: #007700">,&nbsp;</span><span style="color: #DD0000">"r"</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;to&nbsp;read&nbsp;content&nbsp;of&nbsp;the&nbsp;file<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$content</span><span style="color: #007700">=</span><span style="color: #0000BB">fread</span><span style="color: #007700">(</span><span style="color: #0000BB">$fptr</span><span style="color: #007700">,</span><span style="color: #0000BB">filesize</span><span style="color: #007700">(</span><span style="color: #0000BB">$fname</span><span style="color: #007700">));<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;to&nbsp;open&nbsp;for&nbsp;writing<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">$fptw&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #0000BB">fopen</span><span style="color: #007700">(</span><span style="color: #DD0000">"file2.txt"</span><span style="color: #007700">,&nbsp;</span><span style="color: #DD0000">"w"</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;to&nbsp;write&nbsp;content&nbsp;into&nbsp;another&nbsp;file<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">fwrite</span><span style="color: #007700">(</span><span style="color: #0000BB">$fptw</span><span style="color: #007700">,</span><span style="color: #0000BB">$content</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;echo&nbsp;</span><span style="color: #DD0000">"&lt;strong&gt;The&nbsp;content&nbsp;copied&nbsp;in&nbsp;file2&nbsp;is:&lt;/strong&gt;&nbsp;&lt;br&gt;"</span><span style="color: #007700">.&nbsp;</span><span style="color: #0000BB">$content</span><span style="color: #007700">;<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//close&nbsp;files&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">fclose</span><span style="color: #007700">(</span><span style="color: #0000BB">$fptr</span><span style="color: #007700">);<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">fclose</span><span style="color: #007700">(</span><span style="color: #0000BB">$fptw</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;<br /></span>&lt;/body&gt;<br />&lt;/html&gt;</span>
</code></code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="r18wt/Week-4/outputs/w41.png" alt="image" class="img-rounded img-responsive"/><br/>
<hr>
<br/>
<img src="r18wt/Week-4/outputs/w42.png" alt="image" class="img-rounded img-responsive"/><br/>
<hr>
<br/>
<!--<br />
