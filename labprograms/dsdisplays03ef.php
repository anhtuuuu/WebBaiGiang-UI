...
<!-- Mirrored from studyglance.in/labprograms/dsdisplays.php?url1=dslab/Knuth-Morris-Pratt-pattern-matching.html&title=Write%20a%20program%20to%20Implement%20a%20Pattern%20matching%20algorithms%20using%20Knuth-Morris-Pratt by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:48:56 GMT -->
...
<h2>Aim: </h2>
  <h1 style="font-size:18px;color:black;">Write a program to Implement a Pattern matching algorithms using Knuth-Morris-Pratt </h1>
  <h2>Solution : </h2>	

 <h1>C program to Implement a Pattern matching algorithms using Knuth-Morris-Pratt</h1>
<div class="row"> 
	<div class="col-md-12">
		<div class="alert alert-info"><b>Knuth-Morris-Pratt Pattern matching</b><pre><code class="language-c">#include &lt;stdio.h>
#include &lt;string.h>
...
<div class="row"> 
	<div class="col-md-12">
		<div class="alert alert-warning"><b>OUTPUT</b><pre><code class="language-c">pattern is present in text at position 14
</code></pre></div>
	</div>
</div>
