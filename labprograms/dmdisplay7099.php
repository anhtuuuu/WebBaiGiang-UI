...
<!-- Mirrored from studyglance.in/labprograms/dmdisplay.php?url1=dm/loaddataset.html&title=Load%20a%20dataset%20from%20the%20available%20data%20sets%20in%20the%20WEKA%20tool. by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:49:14 GMT -->
...
<h2>Aim: </h2>
  <h1 style="font-size:18px;color:black;"><span style='font-size:25px;color:#ff3333;'>&#9755;</span> &nbsp;Load a dataset from the available data sets in the WEKA tool. </h1>
  <h2>Solution : </h2>	
...
<html lang="en">
 <head>
  ...
  <title>Load a dataset from the available data sets.</title>
  <style>
  p {
  color:black;
  }
 ...
 <body>
 <h1>Load a dataset from the available data sets:</h1>
 <h3> Description: </h3>
 <p>We need to load a dataset from the available data sets to perform various operations like <em>preprocess, classify, clustering, associations, and visualization</em>. 
 <br/>
  </p>
 <br/>
...
<div class="row"> 
	...
	<p> 5) Select a <strong>dataset (iris. arff)</strong> from list of available datasets and Click on the <strong>Open</strong> button.</p><br>
<div class="row"> 
		<div class="col-md-12">
		<img src="dm/images/Weka81.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
		<div class="col-md-4">	
		&nbsp;
		</div>
	</div><br>
	<p> 6) Then displays the following window.</p><br>
<div class="row"> 
		<div class="col-md-12">
		<img src="dm/images/Weka82.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
		<div class="col-md-4">	
		&nbsp;
		</div>
...
<h3> Result:</h3><br>
<p> The dataset <strong>(iris.arff)</strong> loaded successfully form the available data sets in the WEKA tool.</p>
