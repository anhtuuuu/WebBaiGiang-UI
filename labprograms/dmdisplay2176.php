...
<!-- Mirrored from studyglance.in/labprograms/dmdisplay.php?url1=dm/wekadatasets.html&title=Explore%20the%20available%20data%20sets%20in%20WEKA%20tool%20kit. by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:49:11 GMT -->
...
<h2>Aim: </h2>
  <h1 style="font-size:18px;color:black;"><span style='font-size:25px;color:#ff3333;'>&#9755;</span> &nbsp;Explore the available data sets in WEKA tool kit. </h1>
  <h2>Solution : </h2>	
...
<html lang="en">
 <head>
  ...
  <title>Explore the available data sets in WEKA tool kit.</title>
  <style>
  p {
  color:black;
  }
 ...
 <body>
 <h1>Explore the available data sets in WEKA tool kit:</h1>
 <h3> Description: </h3>
 <p>We need to explore the various data sets that are accessible within the WEKA software. There are some sample existing WEKA data sets, in <strong>arff format</strong>. 
 <br/><br>
 Those are,
<ul>
<li>contact-lens.arff</li>
<li>cpu.arff</li>
<li>diabetes.arff</li>
<li>glass.arff</li>
<li>iris.arff</li>
<li>labor.arff</li>
<li>ReutersCorn-train.arff</li>
<li>ReutersCorn-test.arff</li>
<li>ReutersGrain-train.arff</li>
<li>ReutersGrain-test.arff</li>
<li>segment-challenge.arff</li>
<li>segment-test.arff</li>
<li>soybean.arff</li>
<li>supermarket.arff</li>
<li>vote.arff</li>
<li>weather.arff</li>
<li>weather.nominal.arff</li>
</ul>
...
<p>2) In that <strong>Weka GUI chooser</strong> there are five applications, click on <strong>Explorer</strong>.</p><br>
 <div class="row"> 
		<div class="col-md-12">
...
<p>3) Explorer shows many options. In that click on <strong>'open file...'</strong> button. And then choose <strong>WEKA folder</strong> in <strong>C drive</strong>.</p><br>
<div class="row"> 
		<div class="col-md-12">
		<img src="dm/images/Weka72.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
		<div class="col-md-4">	
		&nbsp;
		</div>
	</div><br>
<p> 4) Select and click on the <strong>data </strong>folder.</p><br>
<div class="row"> 
		<div class="col-md-12">
		<img src="dm/images/Weka73.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
		<div class="col-md-4">	
		&nbsp;
		</div>
	</div><br>
	<p> 5) The available datasets are displayed.</p><br>
<div class="row"> 
		<div class="col-md-12">
		<img src="dm/images/Weka74.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
		<div class="col-md-4">	
		&nbsp;
		</div>
...
<h3> Result:</h3><br>
<p> The available <strong>data sets</strong> in the WEKA tool kit were explored..</p>

 </body>

<!-- Mirrored from studyglance.in/labprograms/dmdisplay.php?url1=dm/wekadatasets.html&title=Explore%20the%20available%20data%20sets%20in%20WEKA%20tool%20kit. by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:49:14 GMT -->
</html>
