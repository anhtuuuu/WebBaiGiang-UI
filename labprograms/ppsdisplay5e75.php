...
<!-- Mirrored from studyglance.in/labprograms/ppsdisplay.php?url1=PPS/delete-n-characters-c-program.html&title=Write%20a%20C%20program%20that%20uses%20functions%20to%20delete%20n%20Characters%20from%20a%20given%20position%20in%20a%20given%20string by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:48:29 GMT -->
...
<h1>Write a C program that uses functions to delete n Characters from a given position in a given string.</h1>

<div class="row"> 
<div class="col-md-12">
<div class="alert alert-info"><b>C Program</b> <pre><code class="language-c">//delete n Characters from a given position in a given string.
#include &lt;stdio.h>
#include &lt;string.h>
...
int main() {
    char str[100];
    int position, n;
    void deleteCharacters(char [], int , int );
...
void deleteCharacters(char str[], int position, int n) {
    ...
    // Check if the number of characters to delete is valid
    if (n < 0 || position + n > length) {
        printf("Invalid number of characters to delete!\n");
        return;
    }

    // Shift the remaining characters to the left to overwrite the deleted part
    for (int i = position-1; i < length - n; i++) {
        str[i] = str[i + n];
    }
...
<div class="row"> 
<div class="col-md-12">
<div class="alert alert-warning"><b>OUTPUT</b><pre><code class="language-c">Enter a string: Study at a Glance
Enter the position from where you want to delete: 6
Enter the number of characters to delete: 6
Modified string: StudyGlance</code></pre>
</div></div></div>
<!--
