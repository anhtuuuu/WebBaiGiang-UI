...
<!-- Mirrored from studyglance.in/labprograms/dsdisplays.php?url1=dslab/Queue-using-pointer.html&title=Write%20a%20program%20that%20implement%20Queue%20(its%20operations)%20using%20Linked%20List%20(Pointer) by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:48:55 GMT -->
...
<h2>Aim: </h2>
  <h1 style="font-size:18px;color:black;">Write a program that implement Queue (its operations) using Linked List (Pointer) </h1>
  <h2>Solution : </h2>	

 <h1>C Program to implement Queue using Linked List(pointer)</h1>
<div class="row"> 
<div class="col-md-12">
<div class="alert alert-info"><b>Queue using Linked List</b> <pre><code class="language-c">#include&lt;stdio.h>
#include&lt;stdlib.h>
...
<div class="row"> 
<div class="col-md-12">
<div class="alert alert-warning"><b>OUTPUT</b><pre><code class="language-c">1. Insert
2. Delete
3. Display
4. Exit
Enter your choice:   1
