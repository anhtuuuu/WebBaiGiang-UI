...
<!-- Mirrored from studyglance.in/labprograms/dmdisplay.php?url1=dm/studentdataset.html&title=Demonstration%20of%20creating%20a%20Student%20dataset%20(student.arff)%20using%20WEKA%20tool%20in%20Data%20Mining. by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:49:08 GMT -->
...
<h2>Aim: </h2>
  <h1 style="font-size:18px;color:black;"><span style='font-size:25px;color:#ff3333;'>&#9755;</span> &nbsp;Demonstration of creating a Student dataset (student.arff) using WEKA tool in Data Mining. </h1>
  <h2>Solution : </h2>	
...
<html lang="en">
 <head>
  ...
  <title>Creating a student dataset </title>
  <style>
  p {
  color:black;
  }
 ...
 <body>
 <h1>Creating a student dataset (student.arff):</h1>
 <h3> Description: </h3>
 <p>We need to create a Student Table with training data set which includes attributes like sid, name, various subject marks, total and result.
 <br/></p>
 <br/>
 <h2><font color="#000099"> Procedure: </font></h2>
 <h3> Steps: </h3>
 <p>1) Open any <strong>text editor</strong> (e.g.  Notepad) </p><br>
 <p>2) Type the following training <strong>data set</strong> in the Notepad.</p><br>
 <pre>
	@relation student 
 ...
 <p> 3) After that save the file with <strong>.arff file</strong> format. </p><br>
 <p> 4) Minimize the arff file and then open <strong>Start → Programs → weka-3.8.6.</strong></p><br>
 <p> 5) Click on <strong>weka-3.8.6</strong>, then <strong>Weka GUI chooser</strong> is displayed on the screen.</p><br>
 	<div class="row"> 
		<div class="col-md-12">
...
<p>6) In that <strong>Weka GUI chooser</strong> there are five applications, click on <strong>Explorer</strong>.</p><br>
 <div class="row"> 
		<div class="col-md-12">
		<img src="dm/images/Weka51.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
		<div class="col-md-4">	
		&nbsp;
		</div>
	</div><br>
<p>7) Explorer shows many options. In that click on <strong>'Open file...'</strong> button and select the <strong>.arff file</strong> (e.g. student.arff).</p><br>
<div class="row"> 
		<div class="col-md-12">
		<img src="dm/images/Weka52.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
		<div class="col-md-4">	
		&nbsp;
		</div>
	</div><br>
<p> 8) Click on <strong>edit </strong>button which shows student table on weka.</p><br>
<div class="row"> 
		<div class="col-md-12">
		<img src="dm/images/Weka53.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
		<div class="col-md-4">	
		&nbsp;
		</div>
...
<h3> Result:</h3><br>
<p> The <strong>student dataset</strong> (student.arff) was created successfully using WEKA tool kit.</p>

 </body>

<!-- Mirrored from studyglance.in/labprograms/dmdisplay.php?url1=dm/studentdataset.html&title=Demonstration%20of%20creating%20a%20Student%20dataset%20(student.arff)%20using%20WEKA%20tool%20in%20Data%20Mining. by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:49:09 GMT -->
</html>
