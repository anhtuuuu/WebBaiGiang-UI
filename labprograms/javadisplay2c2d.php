...
<!-- Mirrored from studyglance.in/labprograms/javadisplay.php?url1=java/Contacts.java&url2=java/myfile.txt&url3=&url4=&title=Write%20a%20Java%20Program%20that%20loads%20names%20and%20phone%20numbers%20from%20a%20text%20file%20where%20the%20data%20is%20organized%20as%20one%20line%20per%20record%20and%20each%20filed%20in%20a%20record%20are%20separated%20by%20a%20tab%20(\t).%20It%20takes%20a%20name%20or%20phone%20number%20as%20input%20and%20prints%20the%20corresponding%20other%20value%20from%20the%20hash%20table%20(hint:%20use%20hash%20tables).&alg=&opurl1=java/outputs/w110.png&opurl2=java/outputs/w111.png&opurl3=java/outputs/w112.png&opurl4=&opurl5= by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:48:40 GMT -->
...
import&nbsp;java.io.*;<br />import&nbsp;java.util.*;<br />public&nbsp;class&nbsp;Contacts<br />{<br />public&nbsp;static&nbsp;void&nbsp;main(String&nbsp;args[])<br />{<br />try<br />{<br />FileInputStream&nbsp;fin=new&nbsp;FileInputStream("myfile.txt");<br />Scanner&nbsp;sc=new&nbsp;Scanner(fin).useDelimiter("\t");<br />Hashtable&lt;String,String&gt;&nbsp;ht=new&nbsp;Hashtable&lt;String,String&gt;&nbsp;();<br />String[]&nbsp;strary;<br />String&nbsp;record,name;<br />System.out.println("Phonebook");<br />System.out.println("***********");<br />System.out.println("Name&nbsp;\tNumber");<br />System.out.println("*****\t******");<br />while(sc.hasNext())<br />{<br />String[]&nbsp;ary;<br />record=sc.nextLine();<br />strary=record.split("\t");<br />ht.put(strary[0],strary[1]);<br />System.out.println(strary[0]+"&nbsp;\t&nbsp;"+strary[1]);<br />}<br />System.out.println("--------------------------");<br />Scanner&nbsp;s=new&nbsp;Scanner(System.in);<br />System.out.println("Type&nbsp;the&nbsp;name&nbsp;as&nbsp;given&nbsp;in&nbsp;the&nbsp;phonebook&nbsp;:&nbsp;");<br />name=s.next();<br />name=name.toLowerCase();<br />if(ht.containsKey(name))<br />{<br />System.out.println("phone&nbsp;no&nbsp;is&nbsp;"+ht.get(name));<br />}<br />else<br />{<br />System.out.println("Name&nbsp;is&nbsp;not&nbsp;matched");<br />}<br />}<br />catch(Exception&nbsp;e)<br />{<br />System.out.println(e);<br />}<br />}<br />}</span>
</code></code></pre><br>
 <h3>myfile.txt</h3>
<pre><code class="language-txt"><code><span style="color: #000000">
madhu&nbsp;&nbsp;&nbsp;&nbsp;8801123456<br />ravi&nbsp;&nbsp;&nbsp;&nbsp;9885123456<br />suresh&nbsp;&nbsp;&nbsp;&nbsp;9666123456<br />sona&nbsp;&nbsp;&nbsp;&nbsp;7878123456<br />kiran&nbsp;&nbsp;&nbsp;&nbsp;6767123456</span>
</code></code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="java/outputs/w110.png" alt="image" class="img-rounded img-responsive"/><br/>
<img src="java/outputs/w111.png" alt="image" class="img-rounded img-responsive"/><br/>
<img src="java/outputs/w112.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
