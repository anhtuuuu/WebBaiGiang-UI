...
<!-- Mirrored from studyglance.in/labprograms/r22aidisplay.php?url1=r22ai/BFS.html&title=Breadth%20First%20Search by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:47:55 GMT -->
...
<h1> Write a Program to implement Breadth First Search (BFS) using Python.</h1>
<div class="row"> 
<div class="col-md-12">
<h3>Input Graph</h3>
<img src = "r22ai/images/BFS_Graph.png" class="img-rounded img-responsive"></img>
</div>
</div>
<div class="row"> 
<div class="col-md-12">
<h3>SOURCE CODE : </h3>
<div class="alert alert-info"><pre><code class="language-python"> # Input Graph
graph = {
'A' : ['B','C'],
'B' : ['A','C','D'],
'C' : ['A','B','E'],
