...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <h1 style="font-size:22px;color:black;">Given the following data, which specify classifications for nine ombinationsof VAR1 and VAR2 predict a classification for a case where VAR1=0.906and VAR2=0.606, using the result of k-means clustering with 3 means (i.e., 3centroids)</h1>
  <!--<h2> Explanation : </h2>
  <p></p>-->
  <h2>Source Code: </h2>
  <h3>Week4.py</h3>
<pre><code class="language-py">'''Aim: Given the following data, which specify classifications for nine ombinationsof VAR1 and VAR2 predict a classification for a case where VAR1=0.906and VAR2=0.606, using the result of k-means clustering with 3 means (i.e., 3centroids)
...
print("="*20)
print("The predicted Class is : ",kmeans.predict([test_data]))</code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="ml/outputs/w4.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
...
<!-- Mirrored from studyglance.in/labprograms/mldisplay.php?url1=ml/Week4.py&url2=&url3=&url4=&title=Given%20the%20following%20data,%20which%20specify%20classifications%20for%20nine%20ombinationsof%20VAR1%20and%20VAR2%20predict%20a%20classification%20for%20a%20case%20where%20VAR1=0.906and%20VAR2=0.606,%20using%20the%20result%20of%20k-means%20clustering%20with%203%20means%20(i.e.,%203centroids)&alg=&opurl1=ml/outputs/w4.PNG&opurl2=&opurl3=&opurl4= by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:50:55 GMT -->
</html>
