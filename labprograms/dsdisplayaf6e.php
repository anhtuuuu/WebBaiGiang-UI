...
<!-- Mirrored from studyglance.in/labprograms/dsdisplay.php?url1=ds/insertionsort.c&url2=&url3=&url4=&title=Write%20a%20program%20that%20implements%20Insertion%20Sort%20Method%20to%20sort%20a%20given%20list%20of%20integers%20in%20ascending%20order.&opurl1=ds/outputs/isort.png&opurl2=&opurl3=&opurl4= by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:51:16 GMT -->
...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <p>Write a program that implements Insertion Sort Method to sort a given list of integers in ascending order.</p>
  <h2>Source Code: </h2>
  <h3>insertionsort.c</h3>
<pre><code class="language-c"><code><span style="color: #000000">
#include&lt;stdio.h&gt;<br />int&nbsp;main()<br />{<br />int&nbsp;i,n,a[20];<br />printf("enter&nbsp;n&nbsp;value");<br />scanf("%d",&amp;n);<br />printf("enter&nbsp;%d&nbsp;elements",n);<br />for(i=1;i&lt;=n;i++)<br />{<br />scanf("%d",&amp;a[i]);<br />}<br />insertion(a,n);<br />printf("after&nbsp;sorting\n");<br />for(i=1;i&lt;=n;i++)<br />{<br />printf("%d\t",a[i]);<br />}<br />getch();<br />return&nbsp;1;<br />}<br />int&nbsp;insertion(int&nbsp;a[],int&nbsp;n)<br />{<br />int&nbsp;i,j,b[120];<br />b[1]=a[1];<br />for(i=2;i&lt;=n;i++)<br />{<br />for(j=i-1;j&gt;=1&amp;&amp;b[j]&gt;a[i];j--)<br />{<br />b[j+1]=b[j];<br />}<br />b[j+1]=a[i];<br />}<br />for(i=1;i&lt;=n;i++)<br />a[i]=b[i];<br />}</span>
</code></code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="ds/outputs/isort.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
