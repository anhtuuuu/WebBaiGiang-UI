...
<h2>Aim: </h2>
  <h1 style="font-size:18px;color:black;"><span style='font-size:25px;color:#ff3333;'>&#9755;</span> &nbsp;Explore the features of ES6 like arrow functions, callbacks, promises, async/await. Implement an application for reading the weather information from openweathermap.org and display the information in the form of a graph on the web page. </h1>
  <h2>Solution : </h2>	
...
<html lang="en">
 ...
 <body>
 <h3> <span style='font-size:25px;color:#ff3333;'>&#9755;</span> &nbsp;First, install the required npm packages:
</h3>
<pre><code>
...
<h3> <span style='font-size:25px;color:#ff3333;'>&#9755;</span> &nbsp;Create a file named server.js for the backend:</h3>

 <h3>server.js</h3>
  <pre><code class="language-js"><code><span style="color: #000000">
//&nbsp;server.js<br />constexpress&nbsp;=&nbsp;require('express');<br />constaxios&nbsp;=&nbsp;require('axios');<br /><br />constapp&nbsp;=&nbsp;express();<br />constport&nbsp;=&nbsp;3000;<br /><br />app.use(express.static('public'));<br /><br />app.get('/weather/:city',&nbsp;async&nbsp;(req,&nbsp;res)&nbsp;=&gt;&nbsp;{<br />&nbsp;&nbsp;const{&nbsp;city&nbsp;}&nbsp;=&nbsp;req.params;<br /><br />&nbsp;&nbsp;try&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;constapiKey&nbsp;=&nbsp;'c97c0c1086d42990e89d64d76f50bb61';<br />&nbsp;&nbsp;&nbsp;&nbsp;constresponse&nbsp;=&nbsp;awaitaxios.get(`https://api.openweathermap.org/data/2.5/weather?q=${city}&amp;appid=${apiKey}`);<br />&nbsp;&nbsp;&nbsp;&nbsp;consttemperature&nbsp;=&nbsp;response.data.main.temp;<br />&nbsp;&nbsp;&nbsp;&nbsp;res.json({&nbsp;temperature&nbsp;});<br />&nbsp;&nbsp;}&nbsp;catch&nbsp;(error)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;console.error('Error&nbsp;fetching&nbsp;weather&nbsp;data:',&nbsp;error);<br />&nbsp;&nbsp;&nbsp;&nbsp;res.status(500).json({&nbsp;error:'Internal&nbsp;Server&nbsp;Error'&nbsp;});<br />&nbsp;&nbsp;}<br />});<br /><br />app.listen(port,&nbsp;()&nbsp;=&gt;&nbsp;{<br />&nbsp;&nbsp;console.log(`Server&nbsp;listening&nbsp;at&nbsp;http://localhost:${port}`);<br />});<br /></span>
</code>  </code></pre><br>
 
  <h3> <span style='font-size:25px;color:#ff3333;'>&#9755;</span> &nbsp;Create a folder named public and create an index.html file for the frontend:</h3>
  <h3>index.html</h3>
...
&lt;!DOCTYPE&nbsp;html&gt;<br />&lt;html&nbsp;lang="en"&gt;<br />&lt;head&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&lt;link&nbsp;rel="stylesheet"&nbsp;href="./style.css"&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&lt;title&gt;Home&nbsp;-&nbsp;FBS&lt;/title&gt;<br />&lt;/head&gt;<br />&lt;body&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&lt;div&nbsp;class="wrapper"&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;div&nbsp;class="container"&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;header&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;table&nbsp;width="100%"&nbsp;align="center"&nbsp;cellpadding="0"&nbsp;cellspacing="2"&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;tr&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;th&nbsp;width="20%"&gt;&lt;img&nbsp;src="fbs.png"&nbsp;alt="FBS&nbsp;LOGO"&nbsp;&nbsp;width="130"&nbsp;height="100"/&gt;&lt;/th&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;th&nbsp;colspan=4&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;h1&nbsp;style="color:white;"&gt;FBS&nbsp;-&nbsp;WORLD&nbsp;BEST&nbsp;ONLINE&nbsp;EBOOKS&nbsp;WEBSITE&lt;/h1&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/th&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/tr&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/table&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/header&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;nav&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;table&nbsp;width="100%"&nbsp;align="center"&nbsp;cellpadding="0"&nbsp;cellspacing="2"&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;tbody&nbsp;align="center"&nbsp;&nbsp;style="font-weight:bold;font-size:18px;""&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;tr&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;td&nbsp;width="20%"&gt;&lt;hr&gt;&lt;a&nbsp;href="index.html"&gt;Home&lt;/a&gt;&lt;hr&gt;&lt;/td&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;td&nbsp;width="20%"&gt;&lt;hr&gt;&lt;a&nbsp;href="login.html"&gt;Login&lt;/a&gt;&lt;hr&gt;&lt;/td&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;td&nbsp;width="20%"&gt;&lt;hr&gt;&lt;a&nbsp;href="registration.html"&gt;Registration&lt;/a&gt;&lt;hr&gt;&lt;/td&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;td&nbsp;width="20%"&gt;&lt;hr&gt;&lt;a&nbsp;href="cart.html"&nbsp;&gt;Cart&lt;/a&gt;&lt;hr&gt;&lt;/td&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/tr&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/tbody&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/table&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/nav&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/div&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;div&nbsp;class="container1"&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;div&nbsp;class="sidebar1"&gt;&lt;/div&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;div&nbsp;class="container2"&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;main&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;center&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;h2&gt;Welcome&nbsp;to&nbsp;FBS&nbsp;e-Book's&nbsp;Website&lt;/h2&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;p&gt;Shopping&nbsp;at&nbsp;&lt;font&nbsp;size=5&gt;FBS&lt;/font&gt;&nbsp;can&nbsp;be&nbsp;both&nbsp;&lt;font&nbsp;size=5&gt;fun&lt;/font&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;and&nbsp;&lt;font&nbsp;size=5&gt;savings&lt;/font&gt;.&lt;/br&gt;Shop&nbsp;with&nbsp;us&nbsp;in&nbsp;this&nbsp;special&nbsp;&lt;font<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;size=5&gt;discount&lt;/font&gt;&nbsp;season&nbsp;and&nbsp;save&nbsp;upto&nbsp;&lt;font&nbsp;size=5&gt;90%&lt;/font&gt;&nbsp;on&nbsp;all&nbsp;your<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;purchases.&lt;/br&gt;&lt;/p&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;br/&gt;&lt;br/&gt;&lt;br/&gt;&lt;br/&gt;&lt;br/&gt;&lt;br/&gt;&lt;br/&gt;&lt;br/&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/main&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/div&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;div&nbsp;class="sidebar2"&gt;&lt;/div&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;/div&gt;&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;footer&gt;&lt;font&nbsp;color="white"&gt;(C)&nbsp;2024&nbsp;All&nbsp;rights&nbsp;reserved&nbsp;by&nbsp;FBS&nbsp;ebooks&lt;/font&gt;&lt;/footer&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&lt;/div&gt;<br />&lt;/body&gt;<br />&lt;/html&gt;</span>
  ...
  <h3> <span style='font-size:25px;color:#ff3333;'>&#9755;</span> &nbsp;Now, you can run your Node.js server:</h3>
	<pre><code>
	node server.js
	</code></pre>

	<h3> <span style='font-size:25px;color:#ff3333;'>&#9755;</span> &nbsp;Visit http://localhost:3000 in your web browser.</h3>

	<h2>Create an OpenWeatherMap Account and Generate API Key </h2>
	<ol>
	<li>Visit the OpenWeatherMap website <strong>(https://openweathermap.org/)</strong> and click on <strong>"Sign Up"</strong> or <strong>"Log In"</strong> to create an account or log into your existing account.</li>
  ...
  <h2> Output : </h2>
  <img src="nodejs/weather.png" alt="image" class="img-rounded img-responsive"/><br/>

  <h3> <span style='font-size:25px;color:#ff3333;'>&#9755;</span> &nbsp;Locate API key</h3>
  <h4> Initially It look Like: </h4>
   <img src="nodejs/weather2.png" alt="image" class="img-rounded img-responsive"/><br/>
   <p> <strong>Then, by entering the city then click update chart then </strong></p>
	<img src="nodejs/weather3.png" alt="image" class="img-rounded img-responsive"/><br/>
 </body>
