...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <p>Write a Python program to convert temperatures to and from Celsius, Fahrenheit.  [Formula: c/5 = f-32/9]  </p>
  <h2>Source Code: </h2>
  <h3>week9.py</h3>
<pre><code class="language-py"><code><span style="color: #000000">
'''&nbsp;Write&nbsp;a&nbsp;Python&nbsp;program&nbsp;to&nbsp;convert&nbsp;temperatures&nbsp;to&nbsp;and&nbsp;from&nbsp;Celsius,&nbsp;Fahrenheit.<br />[&nbsp;Formula:&nbsp;c/5&nbsp;=&nbsp;f-32/9]&nbsp;'''<br />print("Options&nbsp;are&nbsp;\n")<br />print("1.Convert&nbsp;temperatures&nbsp;from&nbsp;Celsius&nbsp;to&nbsp;Fahrenheit&nbsp;\n")<br />print("2.Convert&nbsp;temperatures&nbsp;from&nbsp;Fahrenheit&nbsp;to&nbsp;Celsius&nbsp;\n")<br />opt=int(input("Choose&nbsp;any&nbsp;Option(1&nbsp;or&nbsp;2)&nbsp;:&nbsp;"))<br />if&nbsp;opt&nbsp;==&nbsp;1:<br />&nbsp;&nbsp;&nbsp;&nbsp;print("Convert&nbsp;temperatures&nbsp;from&nbsp;Celsius&nbsp;to&nbsp;Fahrenheit&nbsp;\n")<br />&nbsp;&nbsp;&nbsp;&nbsp;cel&nbsp;=&nbsp;float(input("Enter&nbsp;Temperature&nbsp;in&nbsp;Celsius:&nbsp;"))<br />&nbsp;&nbsp;&nbsp;&nbsp;fahr&nbsp;=&nbsp;(cel*9/5)+32<br />&nbsp;&nbsp;&nbsp;&nbsp;print("Temperature&nbsp;in&nbsp;Fahrenheit&nbsp;=",fahr)<br />elif&nbsp;opt&nbsp;==&nbsp;2:<br />&nbsp;&nbsp;&nbsp;&nbsp;print("Convert&nbsp;temperatures&nbsp;from&nbsp;Fahrenheit&nbsp;to&nbsp;Celsius&nbsp;\n")<br />&nbsp;&nbsp;&nbsp;&nbsp;fahr&nbsp;=&nbsp;float(input("Enter&nbsp;Temperature&nbsp;in&nbsp;Fahrenheit:&nbsp;"))<br />&nbsp;&nbsp;&nbsp;&nbsp;cel=(fahr-32)*5/9;<br />&nbsp;&nbsp;&nbsp;&nbsp;print("Temperature&nbsp;in&nbsp;Celsius&nbsp;=",cel)<br />else:<br />&nbsp;&nbsp;&nbsp;&nbsp;print("Invalid&nbsp;Option")<br /></span>
</code></code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="python/outputs/w9.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
