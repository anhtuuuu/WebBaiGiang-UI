...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <h1 style="font-size:22px;color:black;">Implement k-nearest neighbours classification using python</h1>
  <!--<h2> Explanation : </h2>
  <p></p>-->
  <h2>Source Code: </h2>
  <h3>Week3.py</h3>
<pre><code class="language-py">''' Aim : Implement k-nearest neighbours classification using python.
...
try:
	...
	print("Please supply valid input......")</code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="ml/outputs/w31.png" alt="image" class="img-rounded img-responsive"/><br/>
<img src="ml/outputs/w32.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
