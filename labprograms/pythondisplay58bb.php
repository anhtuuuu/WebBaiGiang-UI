...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <p>N-Grams Smoothing </p>
  <h2>Source Code: </h2>
  <h3>week5.py</h3>
<pre><code class="language-py"><code><span style="color: #000000">
'''Aim:&nbsp;Write&nbsp;a&nbsp;program&nbsp;to&nbsp;create,&nbsp;append,&nbsp;and&nbsp;remove&nbsp;lists&nbsp;in&nbsp;python.&nbsp;'''<br />pets&nbsp;=&nbsp;['cat',&nbsp;'dog',&nbsp;'rat',&nbsp;'pig',&nbsp;'tiger']<br />snakes=['python','anaconda','fish','cobra','mamba']<br />print("Pets&nbsp;are&nbsp;:",pets)<br />print("Snakes&nbsp;are&nbsp;:",snakes)<br />animals=pets+snakes<br />print("Animals&nbsp;are&nbsp;:",animals)<br />snakes.remove("fish")<br />print("updated&nbsp;Snakes&nbsp;are&nbsp;:",snakes)&nbsp;</span>
</code></code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="python/outputs/w5.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
