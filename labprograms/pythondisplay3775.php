...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <p>Write a python program to find factorial of a number using Recursion. </p>
  <h2>Source Code: </h2>
  <h3>week12.py</h3>
<pre><code class="language-py"><code><span style="color: #000000">
'''&nbsp;Write&nbsp;a&nbsp;python&nbsp;program&nbsp;to&nbsp;find&nbsp;factorial&nbsp;of&nbsp;a&nbsp;number&nbsp;using&nbsp;Recursion.'''<br />def&nbsp;recur_fact(n):<br />&nbsp;&nbsp;&nbsp;"""Function&nbsp;to&nbsp;return&nbsp;the&nbsp;factorial<br />&nbsp;&nbsp;&nbsp;of&nbsp;a&nbsp;number&nbsp;using&nbsp;recursion"""<br />&nbsp;&nbsp;&nbsp;if&nbsp;n&nbsp;==&nbsp;1:<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;n<br />&nbsp;&nbsp;&nbsp;else:<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;n*recur_fact(n-1)<br /><br />num&nbsp;=&nbsp;int(input("Enter&nbsp;a&nbsp;number:&nbsp;"))<br /><br />#&nbsp;check&nbsp;is&nbsp;the&nbsp;number&nbsp;is&nbsp;negative<br />if&nbsp;num&nbsp;&lt;&nbsp;0:<br />&nbsp;&nbsp;&nbsp;print("Sorry,&nbsp;factorial&nbsp;does&nbsp;not&nbsp;exist&nbsp;for&nbsp;negative&nbsp;numbers")<br />elif&nbsp;num&nbsp;==&nbsp;0:<br />&nbsp;&nbsp;&nbsp;print("The&nbsp;factorial&nbsp;of&nbsp;0&nbsp;is&nbsp;1")<br />else:<br />&nbsp;&nbsp;&nbsp;print("The&nbsp;factorial&nbsp;of",num,"is",recur_fact(num))<br /></span>
</code></code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="python/outputs/w12.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
