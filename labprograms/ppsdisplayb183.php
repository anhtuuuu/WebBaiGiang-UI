...
<!-- Mirrored from studyglance.in/labprograms/ppsdisplay.php?url1=PPS/simple-compound-interest-c-program.html&title=Write%20the%20program%20for%20the%20simple,%20compound%20interest. by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:47:58 GMT -->
...
<h1>Write the program for the simple, compound interest.</h1>

<div class="row"> 
<div class="col-md-12">
<div class="alert alert-info"><b>Algorithm</b> <pre><code>
start
	step1: Read p, rate, time
	step2: SI := (p * rate * time)/100
	step3: CI := p * (1+(rate/100))<sup>time</sup> - p
	step4: Print SI, CI
stop
</code></pre>
</div></div></div>
...
<img src="PPS/images/compound-interest.jpg" width="40%" alt="flowchart for simple, compound interest in c">
</pre>
</div>
</div></div>
<br>
...
<div class="row"> 
<div class="col-md-12">
<div class="alert alert-info"><b>C Programming</b> <pre><code class="language-c">/* calculate the simple interest and compound interest by reading principal amount, rate of interest and time
...
<div class="row"> 
<div class="col-md-12">
<div class="alert alert-warning"><b>OUTPUT</b><pre><code class="language-c">Enter P,R,T: 1000 5 10
SI= 500.000000
CI= 628.893860</code></pre>
</div></div></div><!--
