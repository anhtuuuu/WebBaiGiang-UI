...
<!-- Mirrored from studyglance.in/labprograms/powerbidisplay.php?url1=powerbi/week4.html&title=Applying%20new%20data%20calculations%20to%20your%20visualizations,%20Formatting%20Visualizations,%20Formatting%20Toolsand%20Menus,%20Formatting%20specific%20parts%20of%20the%20view. by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:49:59 GMT -->
...
<h2>Aim: </h2>
  <h1 style="font-size:18px;color:black;">Applying new data calculations to your visualizations, Formatting Visualizations, Formatting Toolsand Menus, Formatting specific parts of the view. </h1>
  <h2>Solution : </h2>	
...
<html lang="en">
 <head>
  ...
  <meta name="Keywords" content="Applying new data calculations to your visualizations, Formatting Visualizations, Formatting Tools and Menus, Formatting specific parts of the view, Tableau calculations">
  <meta name="Description" content="">
  <title>Applying new data calculations to your visualizations, Formatting Visualizations, Formatting Tools and Menus, Formatting specific parts of the view. </title>
 </head>
 <body>
<h1>Applying New Data Calculations to Visualizations</h1>
<h2>1.	Drag and Drop Calculated Fields:</h2> 
<p>To apply your newly created calculated fields to a visualization, simply drag and drop them onto the appropriate shelves in your worksheet. For example, you can drag a calculated field to the Rows or Columns shelf, use it in filters, or place it on the Marks card to control the appearance of marks.</p>
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w4-1.jpg" width="80%" style="border-radius:10px;"/>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
</div>
<h2>2.	Filter with Calculated Fields:</h2> 
<p>Create filters using calculated fields to control which data points are displayed in your visualization. You can use calculated fields to filter by specific criteria, such as a calculated date range or a custom ranking.</p>
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w4-2.jpg" width="80%" style="border-radius:10px;"/>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
...
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w4-3.jpg" width="80%" style="border-radius:10px;"/>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
...
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w4-4.jpg" width="80%" style="border-radius:10px;"/>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
...
<h1>Formatting Visualizations</h1>
<p>Tableau provides a wide range of formatting options to make your visualizations more appealing and informative:</p>
<h2>1.	Format Pane:</h2> 
<p>On the left side of the Tableau interface, you'll find the Format pane. It allows you to format various aspects of your visualization, such as fonts, colors, lines, shading, and borders. Simply select the element you want to format and use the options in the Format pane to make changes.</p>
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w4-5.jpg" width="80%" style="border-radius:10px;" />
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
...
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w4-6.jpg" width="80%" style="border-radius:10px;"/>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
...
<h2>2.	Marks Card:</h2> 
<p>The Marks card, located above your visualization, offers formatting options specific to the type of marks you're using (e.g., color, size, label). Click on the Marks card to access these options and modify how your data is represented.</p>
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w4-7.jpg" width="80%" style="border-radius:10px;"/>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
</div><br>
<h2>3.	Axis and Gridlines:</h2> 
<p>You can format axis labels, titles, and gridlines to improve the readability of your visualization. Right-click on an axis or gridline to access formatting options.</p>
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w4-8.jpg" width="80%" style="border-radius:10px;"/>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
</div><br>
<h2>4.	Legends and Color Scales:</h2> 
<p>Customize legends and color scales to provide context for your visualizations. You can change colors, labels, and the position of legends to match your data.</p>
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w4-9.jpg" width="80%" style="border-radius:10px;"/>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
</div><br>
<h1>Formatting Tools and Menus</h1>
<p>Tableau provides several formatting tools and menus to help you refine the appearance of your visualizations:</p>
<h2>1.	Format Menu:</h2> <p>The Format menu at the top of the Tableau interface provides access to various formatting options, including font styles, shading, borders, alignment, and more. You can use this menu to format text, labels, and other elements.</p>
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w4-10.jpg" width="80%" style="border-radius:10px;"/>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
</div><br> 
<h2>2.	Worksheet Menu:</h2> <p>In the Worksheet menu, you'll find options to format the entire worksheet, including background color, borders, and worksheet title. You can also adjust the worksheet size.</p>
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w4-11.jpg" width="80%" style="border-radius:10px;"/>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
</div><br>
<h2>3.	Dashboard Menu:</h2> <p>If you're working with dashboards, the Dashboard menu allows you to format the entire dashboard layout, including background, size, and title.</p>
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w4-12.jpg" width="80%" style="border-radius:10px;"/>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
</div><br> 
<h1>Formatting Specific Parts of the View</h1>
<p>Tableau lets you format specific elements of your visualization:</p>
<h2>1.	Annotations:</h2> <p>You can add annotations to your visualizations to highlight important points or provide additional context. Format these annotations using the options available when you right-click on an annotation.</p>
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w4-13.jpg" width="80%" style="border-radius:10px;"/>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
</div><br> 
<h2>2.	Tooltips:</h2> <p>Customize tooltips to display relevant information when users hover over data points. You can format tooltips to show or hide specific fields and control their appearance.</p>
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w4-14.jpg" width="80%" style="border-radius:10px;"/>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
</div><br> 
<h2>3.	Headers and Titles:</h2> <p>Format headers, titles, and subtitles for clarity and consistency. Use the Format pane or the Format menu to adjust text formatting, alignment, and shading.</p>
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w4-15.jpg" width="80%" style="border-radius:10px;"/>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
...
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w4-16.jpg" width="80%" style="border-radius:10px;"/>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
...
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w4-17.jpg" width="80%" style="border-radius:10px;"/>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
...
<!-- Mirrored from studyglance.in/labprograms/powerbidisplay.php?url1=powerbi/week4.html&title=Applying%20new%20data%20calculations%20to%20your%20visualizations,%20Formatting%20Visualizations,%20Formatting%20Toolsand%20Menus,%20Formatting%20specific%20parts%20of%20the%20view. by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:50:23 GMT -->
</html>
