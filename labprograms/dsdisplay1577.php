...
<!-- Mirrored from studyglance.in/labprograms/dsdisplay.php?url1=ds/bst.c&url2=&url3=&url4=&title=Write%20a%20program%20to%20implement%20the%20tree%20traversal%20methods.&opurl1=ds/outputs/bst.png&opurl2=&opurl3=&opurl4= by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:51:18 GMT -->
...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <p>Write a program to implement the tree traversal methods.</p>
  <h2>Source Code: </h2>
  <h3>bst.c</h3>
<pre><code class="language-c"><code><span style="color: #000000">
#include&lt;stdio.h&gt;<br />#include&lt;stdlib.h&gt;<br />typedef&nbsp;struct&nbsp;BST<br />{<br />int&nbsp;data;<br />struct&nbsp;BST&nbsp;*left;<br />struct&nbsp;BST&nbsp;*right;<br />}node;<br /><br />node&nbsp;*create();<br />void&nbsp;insert(node&nbsp;*,node&nbsp;*);<br />void&nbsp;preorder(node&nbsp;*);<br />void&nbsp;inorder(node&nbsp;*);<br />void&nbsp;postorder(node&nbsp;*);<br /><br />int&nbsp;main()<br />{<br />char&nbsp;ch;<br />node&nbsp;*root=NULL,*temp;<br /><br />do<br />{<br />temp=create();<br />if(root==NULL)<br />root=temp;<br />else<br />insert(root,temp);<br />printf("nDo&nbsp;you&nbsp;want&nbsp;to&nbsp;enter&nbsp;more(y/n)?");<br />getchar();<br />scanf("%c",&amp;ch);<br />}while(ch=='y'|ch=='Y');<br /><br />printf("\nPreorder&nbsp;Traversal:&nbsp;");<br />preorder(root);<br /><br />printf("\nInorder&nbsp;Traversal:&nbsp;");<br />inorder(root);<br /><br />printf("\nPostorder&nbsp;Traversal:&nbsp;");<br />postorder(root);<br />return&nbsp;0;<br />}<br /><br />node&nbsp;*create()<br />{<br />node&nbsp;*temp;<br />printf("nEnter&nbsp;data:");<br />temp=(node*)malloc(sizeof(node));<br />scanf("%d",&amp;temp-&gt;data);<br />temp-&gt;left=temp-&gt;right=NULL;<br />return&nbsp;temp;<br />}<br /><br />void&nbsp;insert(node&nbsp;*root,node&nbsp;*temp)<br />{<br />if(temp-&gt;data&lt;root-&gt;data)<br />{<br />if(root-&gt;left!=NULL)<br />insert(root-&gt;left,temp);<br />else<br />root-&gt;left=temp;<br />}<br /><br />if(temp-&gt;data&gt;root-&gt;data)<br />{<br />if(root-&gt;right!=NULL)<br />insert(root-&gt;right,temp);<br />else<br />root-&gt;right=temp;<br />}<br />}<br /><br />void&nbsp;preorder(node&nbsp;*root)<br />{<br />if(root!=NULL)<br />{<br />printf("%d&nbsp;",root-&gt;data);<br />preorder(root-&gt;left);<br />preorder(root-&gt;right);<br />}<br />}<br /><br />void&nbsp;inorder(node&nbsp;*root)<br />{<br />if(root!=NULL)<br />{<br />inorder(root-&gt;left);<br />printf("%d&nbsp;",root-&gt;data);<br />inorder(root-&gt;right);<br />}<br />}<br /><br />void&nbsp;postorder(node&nbsp;*root)<br />{<br />if(root!=NULL)<br />{<br />postorder(root-&gt;left);<br />postorder(root-&gt;right);<br />printf("%d&nbsp;",root-&gt;data);<br /><br />}<br />}</span>
</code></code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="ds/outputs/bst.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
