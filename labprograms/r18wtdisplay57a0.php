...
<!-- Mirrored from studyglance.in/labprograms/r18wtdisplay.php?url1=r18wt/Week-2/Week2.php&url2=&url3=&url4=&url5=&url6=&url7=&url8=&url9=&url10=&url11=&url12=&url13=&title=PHP%20script%20to%20%20%20a)%20Find%20the%20length%20of%20a%20string.%20b)%20Count%20no%20of%20words%20in%20a%20string.%20%20c)%20Reverse%20a%20string.%20%20%20d)%20Search%20for%20a%20specific%20string.%20%20%20&alg=&opurl1=r18wt/Week-2/outputs/w21.png&opurl2=&opurl3=&opurl4=&opurl5=&opurl6=&opurl7=&opurl8=&opurl9=&opurl10= by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:51:08 GMT -->
...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <h3><pre style="border:none;font-size:15px;font-color:#000033;"> PHP script to   a) Find the length of a string. b) Count no of words in a string.  c) Reverse a string.   d) Search for a specific string.   </pre> </h3>
  <!--<h2> Algorithm </h2>
  <pre></pre>-->
  <h2>Source Code: </h2>
  <h3>Week-2/Week2.php</h3>
<pre><code class="language-php"><code><span style="color: #000000">
&lt;html&gt;<br />&lt;head&gt;<br />&nbsp;&nbsp;&nbsp;&nbsp;&lt;title&gt;String&nbsp;Operations&nbsp;in&nbsp;PHP&lt;/title&gt;<br />&lt;/head&gt;<br />&lt;body&gt;<br /><span style="color: #0000BB">&lt;?php<br /></span><span style="color: #FF8000">/*<br />strlen()&nbsp;function&nbsp;returns&nbsp;the&nbsp;length&nbsp;of&nbsp;a&nbsp;string.<br />str_word_count()&nbsp;function&nbsp;counts&nbsp;the&nbsp;number&nbsp;of&nbsp;words&nbsp;in&nbsp;a&nbsp;string.<br />strrev()&nbsp;function&nbsp;reverses&nbsp;a&nbsp;string.<br />strpos()&nbsp;function&nbsp;searches&nbsp;for&nbsp;a&nbsp;specific&nbsp;text&nbsp;within&nbsp;a&nbsp;string.<br /><br />*/<br /></span><span style="color: #0000BB">$mystr</span><span style="color: #007700">=</span><span style="color: #DD0000">"PHP&nbsp;is&nbsp;a&nbsp;server&nbsp;side&nbsp;scripting&nbsp;language"</span><span style="color: #007700">;<br />echo&nbsp;</span><span style="color: #DD0000">"&lt;strong&gt;The&nbsp;given&nbsp;string&nbsp;is&nbsp;:&nbsp;&lt;/strong&gt;&nbsp;</span><span style="color: #0000BB">$mystr</span><span style="color: #DD0000">&lt;br&gt;"</span><span style="color: #007700">;<br />echo&nbsp;</span><span style="color: #DD0000">"&lt;strong&gt;The&nbsp;length&nbsp;of&nbsp;given&nbsp;string&nbsp;is&nbsp;:&nbsp;&lt;/strong&gt;&nbsp;"</span><span style="color: #007700">.</span><span style="color: #0000BB">strlen</span><span style="color: #007700">(</span><span style="color: #0000BB">$mystr</span><span style="color: #007700">).</span><span style="color: #DD0000">"&lt;br&gt;"</span><span style="color: #007700">;<br />echo&nbsp;</span><span style="color: #DD0000">"&lt;strong&gt;The&nbsp;number&nbsp;of&nbsp;words&nbsp;are&nbsp;:&nbsp;&lt;/strong&gt;"</span><span style="color: #007700">.</span><span style="color: #0000BB">str_word_count</span><span style="color: #007700">(</span><span style="color: #0000BB">$mystr</span><span style="color: #007700">).</span><span style="color: #DD0000">"&lt;br&gt;"</span><span style="color: #007700">;<br />echo&nbsp;</span><span style="color: #DD0000">"&lt;strong&gt;The&nbsp;Reverse&nbsp;of&nbsp;a&nbsp;given&nbsp;String&nbsp;is&nbsp;:&nbsp;&lt;/strong&gt;&nbsp;"</span><span style="color: #007700">.</span><span style="color: #0000BB">strrev</span><span style="color: #007700">(</span><span style="color: #0000BB">$mystr</span><span style="color: #007700">).</span><span style="color: #DD0000">"&lt;br&gt;"</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$substr</span><span style="color: #007700">=</span><span style="color: #DD0000">"server"</span><span style="color: #007700">;<br />echo&nbsp;</span><span style="color: #DD0000">"&lt;strong&gt;The&nbsp;Position&nbsp;of&nbsp;a&nbsp;Sub&nbsp;String&nbsp;'</span><span style="color: #0000BB">$substr</span><span style="color: #DD0000">'&nbsp;in&nbsp;the&nbsp;String&nbsp;is&nbsp;:&nbsp;&lt;/strong&gt;&nbsp;"</span><span style="color: #007700">.</span><span style="color: #0000BB">strpos</span><span style="color: #007700">(</span><span style="color: #0000BB">$mystr</span><span style="color: #007700">,</span><span style="color: #0000BB">$substr</span><span style="color: #007700">);<br /></span><span style="color: #0000BB">?&gt;<br /></span>&lt;/body&gt;<br />&lt;/html&gt;</span>
</code></code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="r18wt/Week-2/outputs/w21.png" alt="image" class="img-rounded img-responsive"/><br/>
<hr>
<br/>
<!--<br />
