...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <p>Write a Python script that prints prime numbers less than 20. </p>
  <h2>Source Code: </h2>
  <h3>week11.py</h3>
<pre><code class="language-py"><code><span style="color: #000000">
'''Write&nbsp;a&nbsp;Python&nbsp;script&nbsp;that&nbsp;prints&nbsp;prime&nbsp;numbers&nbsp;less&nbsp;than&nbsp;20'''<br /><br />print("Prime&nbsp;numbers&nbsp;between&nbsp;1&nbsp;and&nbsp;20&nbsp;are:")<br />ulmt=20;<br />for&nbsp;num&nbsp;in&nbsp;range(ulmt):<br />&nbsp;&nbsp;&nbsp;#&nbsp;prime&nbsp;numbers&nbsp;are&nbsp;greater&nbsp;than&nbsp;1<br />&nbsp;&nbsp;&nbsp;if&nbsp;num&nbsp;&gt;&nbsp;1:<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for&nbsp;i&nbsp;in&nbsp;range(2,num):<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;(num&nbsp;%&nbsp;i)&nbsp;==&nbsp;0:<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;break<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;else:<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;print(num)</span>
</code></code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="python/outputs/w11.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
