...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <p>Write a program that implement Stack (its operations) using Arrays                    </p>
  <h2>Source Code: </h2>
  <h3>stackarr.c</h3>
<pre><code class="language-c"><code><span style="color: #000000">
#include&lt;stdio.h&gt;<br />#include&lt;conio.h&gt;<br />#define&nbsp;max&nbsp;5<br />int&nbsp;st[max],top=-1;<br />void&nbsp;push()<br />{<br />int&nbsp;x;<br />if(top==max-1)<br />{<br />printf("stack&nbsp;is&nbsp;full");<br />return;<br />}<br />printf("enter&nbsp;element");<br />scanf("%d",&amp;x);<br />top++;<br />st[top]=x;<br />}<br />void&nbsp;pop()<br />{<br />int&nbsp;x;<br />if(top==-1)<br />{<br />printf("stack&nbsp;is&nbsp;empty");<br />return;<br />}<br />printf("enter&nbsp;element");<br />scanf("%d",&amp;x);<br />top--;<br />printf("enter&nbsp;deleted&nbsp;element=%d",x);<br />}<br />void&nbsp;display()<br />{<br />int&nbsp;i;<br />if(top==-1)<br />{<br />printf("stack&nbsp;is&nbsp;empty");<br />return;}<br />for(i=top;i&gt;=0;i--)<br />{<br />printf("%d",st[i]);<br />}}<br />int&nbsp;main()<br />{<br />int&nbsp;ch;<br />while(1)<br />{<br />printf("enter&nbsp;\n1.push\n2.pop\n3.display\n4.exit");<br />scanf("%d",&amp;ch);<br />switch(ch)<br />{<br />case&nbsp;1:push();break;<br />case&nbsp;2:pop();break;<br />case&nbsp;3:display();break;<br />case&nbsp;4:exit(1);break;<br />}}<br />return&nbsp;1;<br />}<br /></span>
</code></code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="ds/outputs/stacka.png" alt="image" class="img-rounded img-responsive"/><br/>
<img src="ds/outputs/stackb.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
