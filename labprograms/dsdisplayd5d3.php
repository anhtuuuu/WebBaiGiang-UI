...
<!-- Mirrored from studyglance.in/labprograms/dsdisplay.php?url1=ds/Selectionsort.c&url2=&url3=&url4=&title=Write%20a%20program%20that%20implements%20Selection%20Sort%20Method%20to%20sort%20a%20given%20list%20of%20integers%20in%20ascending%20order.&opurl1=ds/outputs/ssort.png&opurl2=&opurl3=&opurl4= by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:51:16 GMT -->
...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <p>Write a program that implements Selection Sort Method to sort a given list of integers in ascending order.</p>
  <h2>Source Code: </h2>
  <h3>Selectionsort.c</h3>
<pre><code class="language-c"><code><span style="color: #000000">
#include&lt;stdio.h&gt;<br />#include&lt;conio.h&gt;<br />void&nbsp;selectionsort(int&nbsp;a[],int&nbsp;n);<br />int&nbsp;main()<br />{<br />int&nbsp;a[20],i,n;<br /><br />printf("enter&nbsp;how&nbsp;many&nbsp;values&nbsp;you&nbsp;want");<br />scanf("%d",&amp;n);<br />printf("enter&nbsp;%d&nbsp;elements",n);<br />for(i=0;i&lt;n;i++)<br />{<br />scanf("%d",&amp;a[i]);<br />}<br />selectionsort(a,n);<br />printf("after&nbsp;sorting\n");<br />for(i=0;i&lt;n;i++)<br />{<br />printf("%d\n",a[i]);<br />}<br />getch();<br />return&nbsp;1;<br />}<br />void&nbsp;selectionsort(int&nbsp;a[],int&nbsp;n)<br />{<br />int&nbsp;min,i,j,t;<br />for(i=0;i&lt;n;i++)<br />{<br />min=i;<br />for(j=i+1;j&lt;n;j++)<br />{<br />if(a[j]&lt;a[min])<br />{<br />min=j;<br />}<br />}<br />t=a[i];<br />a[i]=a[min];<br />a[min]=t;<br />}<br />}</span>
</code></code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="ds/outputs/ssort.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
