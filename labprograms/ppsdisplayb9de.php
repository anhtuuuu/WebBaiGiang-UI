...
<!-- Mirrored from studyglance.in/labprograms/ppsdisplay.php?url1=PPS/greatest-common-divisor-c-programm.html&title=Write%20C%20programs%20that%20use%20both%20recursive%20and%20non-recursive%20functions%20to%20find%20the%20GCD%20(greatest%20common%20divisor)%20of%20two%20given%20integers. by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:48:28 GMT -->
...
<h1>Write C programs that use both recursive and non-recursive functions to find the GCD (greatest common divisor) of two given integers.</h1>
<p>Using Euclidean Algorithm: The GCD of two numbers a and b is the same as the GCD of  b and a%b <br>
That is: GCD(a, b) = GCD(b, a%b)<br>
This process continues until one of the numbers becomes zero. At that point, the non-zero number is the GCD.</p>
<div class="row"> 
<div class="col-md-12">
...
<div class="row"> 
<div class="col-md-12">
<div class="alert alert-info"><b>C Programming</b> <pre><code class="language-c">//use both recursive and non-recursive functions to find the GCD (greatest common divisor) of two given integers.
#include &lt;stdio.h>
...
<div class="row"> 
<div class="col-md-12">
<div class="alert alert-warning"><b>OUTPUT</b><pre><code class="language-c">Enter the first integer (a): 45
Enter the second integer (b): 65
GCD of 45 and 65 is 5
GCD of 45 and 65 is 5</code></pre>
</div></div></div><!--
