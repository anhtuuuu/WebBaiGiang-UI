...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <p> Write a Java program to demonstrate the OOP principles. [i.e., Encapsulation, Inheritance, Polymorphism and Abstraction] </p>
  <!--<h2> Algorithm </h2>
  <pre></pre>-->
  <h2>Source Code: </h2>
  <h3>OopPrinciplesDemo.java</h3>
<pre><code class="language-java"><code><span style="color: #000000">
/*&nbsp;Encapsulation:&nbsp;<br />&nbsp;&nbsp;&nbsp;The&nbsp;fields&nbsp;of&nbsp;the&nbsp;class&nbsp;are&nbsp;private&nbsp;and&nbsp;accessed&nbsp;through&nbsp;getter&nbsp;and&nbsp;setter&nbsp;methods.*/<br />class&nbsp;Person&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;private&nbsp;fields<br />&nbsp;&nbsp;&nbsp;&nbsp;private&nbsp;String&nbsp;name;<br />&nbsp;&nbsp;&nbsp;&nbsp;private&nbsp;int&nbsp;age;<br />&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;constructor<br />&nbsp;&nbsp;&nbsp;&nbsp;public&nbsp;Person(String&nbsp;name,&nbsp;int&nbsp;age)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.name&nbsp;=&nbsp;name;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.age&nbsp;=&nbsp;age;<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br />&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;getter&nbsp;and&nbsp;setter&nbsp;methods<br />&nbsp;&nbsp;&nbsp;&nbsp;public&nbsp;String&nbsp;getName()&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;name;<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br />&nbsp;&nbsp;&nbsp;&nbsp;public&nbsp;void&nbsp;setName(String&nbsp;name)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.name&nbsp;=&nbsp;name;<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br />&nbsp;&nbsp;&nbsp;&nbsp;public&nbsp;int&nbsp;getAge()&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;age;<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br />&nbsp;&nbsp;&nbsp;&nbsp;public&nbsp;void&nbsp;setAge(int&nbsp;age)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.age&nbsp;=&nbsp;age;<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br />&nbsp;&nbsp;&nbsp;&nbsp;/*&nbsp;Abstraction:&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The&nbsp;displayInfo()&nbsp;method&nbsp;provides&nbsp;a&nbsp;simple&nbsp;interface&nbsp;to&nbsp;interact&nbsp;with&nbsp;the&nbsp;object.*/<br />&nbsp;&nbsp;&nbsp;&nbsp;public&nbsp;void&nbsp;displayInfo()&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;System.out.println("Name:&nbsp;"&nbsp;+&nbsp;name);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;System.out.println("Age:&nbsp;"&nbsp;+&nbsp;age);<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br />}<br /><br />/*&nbsp;Inheritance:&nbsp;<br />&nbsp;&nbsp;&nbsp;Employee&nbsp;is&nbsp;a&nbsp;subclass&nbsp;of&nbsp;Person,&nbsp;inheriting&nbsp;its&nbsp;properties&nbsp;and&nbsp;methods.*/<br />class&nbsp;Employee&nbsp;extends&nbsp;Person&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;private&nbsp;field<br />&nbsp;&nbsp;&nbsp;&nbsp;private&nbsp;double&nbsp;salary;<br />&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;constructor<br />&nbsp;&nbsp;&nbsp;&nbsp;public&nbsp;Employee(String&nbsp;name,&nbsp;int&nbsp;age,&nbsp;double&nbsp;salary)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;super(name,&nbsp;age);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.salary&nbsp;=&nbsp;salary;<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br />&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;getter&nbsp;and&nbsp;setter&nbsp;methods<br />&nbsp;&nbsp;&nbsp;&nbsp;public&nbsp;double&nbsp;getSalary()&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;salary;<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br />&nbsp;&nbsp;&nbsp;&nbsp;public&nbsp;void&nbsp;setSalary(double&nbsp;salary)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;this.salary&nbsp;=&nbsp;salary;<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;/*&nbsp;Polymorphism:<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Overriding&nbsp;the&nbsp;displayInfo()&nbsp;method&nbsp;to&nbsp;provide&nbsp;a&nbsp;specific&nbsp;implementation&nbsp;for&nbsp;Employee.*/<br />&nbsp;&nbsp;&nbsp;&nbsp;@Override<br />&nbsp;&nbsp;&nbsp;&nbsp;public&nbsp;void&nbsp;displayInfo()&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;super.displayInfo();<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;System.out.println("Salary:&nbsp;"&nbsp;+&nbsp;salary);<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br />}<br /><br />public&nbsp;class&nbsp;OopPrinciplesDemo&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;public&nbsp;static&nbsp;void&nbsp;main(String[]&nbsp;args)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;Demonstrating&nbsp;encapsulation&nbsp;and&nbsp;abstraction<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Person&nbsp;person&nbsp;=&nbsp;new&nbsp;Person("Madhu",&nbsp;30);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;System.out.println("Person&nbsp;Info:");<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;person.displayInfo();<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;System.out.println("====================");<br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;Demonstrating&nbsp;inheritance&nbsp;and&nbsp;polymorphism<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Employee&nbsp;employee&nbsp;=&nbsp;new&nbsp;Employee("Naveen",&nbsp;26,&nbsp;50000);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;System.out.println("Employee&nbsp;Info:");<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;employee.displayInfo();<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br />}<br /></span>
</code></code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="java/outputs/r22w21.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
