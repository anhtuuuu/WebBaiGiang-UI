...
<!-- Mirrored from studyglance.in/labprograms/ppsdisplay.php?url1=PPS/insert-a-sub-string-c-program.html&title=Write%20a%20C%20program%20that%20uses%20functions%20to%20insert%20a%20sub-string%20into%20a%20given%20main%20string%20from%20a%20given%20position by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:48:29 GMT -->
...
<h1> Write a C program that uses functions to insert a sub-string into a given main string from a given position.</h1>

<div class="row"> 
<div class="col-md-12">
<div class="alert alert-info"><b>C Program</b> <pre><code class="language-c">//insert a sub-string into a given main string from a given position.
#include &lt;stdio.h>
#include &lt;string.h>

// Function to insert a substring into the main string at the given position
void insertSubstring(char *mainStr, const char *subStr, int position) {
    int i, mainLen, subLen;

    mainLen = strlen(mainStr);
    subLen = strlen(subStr);

    // Shift characters of mainStr to the right to make space for the substring
    for (i = mainLen - 1; i >= position; i--) {
...
int main() {
    ...
    // Input the main string, substring, and position
...
<div class="row"> 
<div class="col-md-12">
<div class="alert alert-warning"><b>OUTPUT</b><pre><code class="language-c">Enter the main string: welcome to Glance
Enter the substring: Study
Enter the position to insert the substring: 11
Modified string: welcome to StudyGlance </code></pre>
</div></div></div>
<!--
