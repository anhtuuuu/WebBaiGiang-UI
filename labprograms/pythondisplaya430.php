...
<!-- Mirrored from studyglance.in/labprograms/pythondisplay.php?url1=python/week8.py&url2=&url3=&url4=&title=Write%20a%20python%20program%20to%20find%20largest%20of%20three%20numbers.%20&opurl1=python/outputs/w8.png&opurl2=&opurl3=&opurl4= by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:50:45 GMT -->
...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <p>Write a python program to find largest of three numbers.  </p>
  <h2>Source Code: </h2>
  <h3>week8.py</h3>
<pre><code class="language-py"><code><span style="color: #000000">
'''&nbsp;Write&nbsp;a&nbsp;python&nbsp;program&nbsp;to&nbsp;find&nbsp;largest&nbsp;of&nbsp;three&nbsp;numbers&nbsp;'''<br />num1&nbsp;=&nbsp;int(input("Enter&nbsp;first&nbsp;number:&nbsp;"))<br />num2&nbsp;=&nbsp;int(input("Enter&nbsp;second&nbsp;number:&nbsp;"))<br />num3&nbsp;=&nbsp;int(input("Enter&nbsp;third&nbsp;number:&nbsp;"))<br />&nbsp;<br />if&nbsp;(num1&nbsp;&gt;&nbsp;num2)&nbsp;and&nbsp;(num1&nbsp;&gt;&nbsp;num3):<br />&nbsp;&nbsp;&nbsp;largest&nbsp;=&nbsp;num1<br />elif&nbsp;(num2&nbsp;&gt;&nbsp;num1)&nbsp;and&nbsp;(num2&nbsp;&gt;&nbsp;num3):<br />&nbsp;&nbsp;&nbsp;largest&nbsp;=&nbsp;num2<br />else:<br />&nbsp;&nbsp;&nbsp;largest&nbsp;=&nbsp;num3<br />&nbsp;<br />print("The&nbsp;largest&nbsp;number&nbsp;is",largest)</span>
</code></code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="python/outputs/w8.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
...
<!-- Mirrored from studyglance.in/labprograms/pythondisplay.php?url1=python/week8.py&url2=&url3=&url4=&title=Write%20a%20python%20program%20to%20find%20largest%20of%20three%20numbers.%20&opurl1=python/outputs/w8.png&opurl2=&opurl3=&opurl4= by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:50:46 GMT -->
</html>
