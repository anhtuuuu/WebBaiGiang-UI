...
<!-- Mirrored from studyglance.in/labprograms/ppsdisplay.php?url1=PPS/Prime-numbers-between-1-to-n-c-program.html&title=Write%20a%20C%20program%20to%20generate%20all%20the%20prime%20numbers%20between%201%20and%20n,%20where%20n%20is%20a%20value%20supplied%20by%20the%20user by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:48:22 GMT -->
...
<h1>Write a C program to generate all the prime numbers between 1 and n, where n is a value supplied by the user.</h1>
...
start
	step1: Read number
	step2: for j := 2 to number step 1 do
	step3: 	count := 0
	step4: 	for i := 2 to j/2 step 1 do
	step5: 	   if j%i = 0 then
	step6:  	count := count + 1
	step7: 		break	
	step8:	if count = 0 then 
	step9: 	   Print j
stop
</code></pre>
</div></div></div>
...
<img src="PPS/images/prime-numbers-range.jpg" width="60%" alt="flowchart for all the prime numbers between 1 to n in c">
</pre>
</div>
</div></div>
<br>
...
<div class="row"> 
<div class="col-md-12">
<div class="alert alert-info"><b>C Programming</b> <pre><code class="language-c">//to generate all the prime numbers between 1 to n.
#include &lt;stdio.h>
...
<div class="row"> 
<div class="col-md-12">
<div class="alert alert-warning"><b>OUTPUT</b><pre><code class="language-c">Enter a number: 15
...
<!-- Mirrored from studyglance.in/labprograms/ppsdisplay.php?url1=PPS/Prime-numbers-between-1-to-n-c-program.html&title=Write%20a%20C%20program%20to%20generate%20all%20the%20prime%20numbers%20between%201%20and%20n,%20where%20n%20is%20a%20value%20supplied%20by%20the%20user by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:48:24 GMT -->
</html>
