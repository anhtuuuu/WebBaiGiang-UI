...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <h1 style="font-size:22px;color:black;">The following training examples map descriptions of individuals onto high, medium and low credit-worthiness.Input attributes are (from left to right) income, recreation, job, status, age-group, home-owner. Find the unconditional probability of 'golf' and the conditional probability of 'single' given 'medRisk' in the dataset</h1>
  <!--<h2> Explanation : </h2>
  <p></p>-->
  <h2>Source Code: </h2>
  <h3>Week5.py</h3>
<pre><code class="language-py">'''Aim:The following training examples map descriptions of individuals onto high, medium and low credit-worthiness.
...
print("Conditional probability of single given medRisk: = {}".format(conditionalProb))</code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="ml/outputs/w5.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
