...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <h1 style="font-size:22px;color:black;">Assume the prolog predicate gt(A, B) is true when A is greater than B. Use this predicate todefine the predicate addLeaf(Tree, X, NewTree) which is true if NewTree is the Treeproducedby adding the item X in a leaf node. Tree and NewTree are binary search trees. Theempty treeis represented by the atom nil. </h1>
  <h2>Solution : </h2>
  <!--<h3>week10.pl</h3>-->
