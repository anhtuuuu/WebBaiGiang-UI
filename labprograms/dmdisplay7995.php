...
<!-- Mirrored from studyglance.in/labprograms/dmdisplay.php?url1=dm/texttoarfffile.html&title=Conversion%20of%20a%20Text%20file%20into%20ARFF%20(Attribute-Relation%20File%20Format)%20using%20Weka%20tool. by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:49:16 GMT -->
...
<h2>Aim: </h2>
  <h1 style="font-size:18px;color:black;"><span style='font-size:25px;color:#ff3333;'>&#9755;</span> &nbsp;Conversion of a Text file into ARFF (Attribute-Relation File Format) using Weka tool. </h1>
  <h2>Solution : </h2>	
...
<html lang="en">
 ...
 <body>
 <h3> Description: </h3>
 <p>Most of the data that has been gathered from <strong>public forums</strong> is in a <strong>textual format</strong> that is incompatible with the Weka tool. As Weka, a data mining tool, exclusively recognizes data in the ARFF format, it is necessary to convert the text file into an ARFF file. </em>. 
 <br/>
  </p>
 <h2><font color="#000099"> Conversion of Text File into ARFF File : </font></h2>
 <h3><u>Procedure:</u></h2>
 <h3> Steps: </h3>
<p>1) <strong>Download</strong> any data set from a <strong>public forum (E.g.:  UCI data repository.)</strong></p><br/>
<div class="row"> 
		<div class="col-md-12">
		<img src="dm/images/Weka101.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
		<div class="col-md-4">	
		&nbsp;
		</div>
</div>
<p>2) Open the downloaded data file using <strong>notepad</strong>.</p><br/>
<div class="row"> 
		<div class="col-md-12">
		<img src="dm/images/Weka102.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
		<div class="col-md-4">	
		&nbsp;
		</div>
</div>
<p>3) <strong>Add one row </strong>at the top of the data and Enter <strong>header </strong>for each column. </p><br/>
<div class="row"> 
		<div class="col-md-12">
		<img src="dm/images/Weka103.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
		<div class="col-md-4">	
		&nbsp;
		</div>
</div>
<p>4) Save the file as <strong>.CSV (Comma Separated Values)</strong> format.</p><br/>
<div class="row"> 
		<div class="col-md-12">
		<img src="dm/images/Weka104.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
		<div class="col-md-4">	
		&nbsp;
		</div>
</div>
<p>5) Open Weka tool and then click on Explorer. From the Preprocessor tab and open the <strong>CSV file</strong>.</p><br/>
<div class="row"> 
		<div class="col-md-12">
		<img src="dm/images/Weka105.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
		<div class="col-md-4">	
		&nbsp;
		</div>
</div>
<p>6) Save that file as <strong>ARFF format</strong>.</p><br/>
<div class="row"> 
		<div class="col-md-12">
		<img src="dm/images/Weka106.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
		<div class="col-md-4">	
		&nbsp;
		</div>
...
<!-- Mirrored from studyglance.in/labprograms/dmdisplay.php?url1=dm/texttoarfffile.html&title=Conversion%20of%20a%20Text%20file%20into%20ARFF%20(Attribute-Relation%20File%20Format)%20using%20Weka%20tool. by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:49:18 GMT -->
</html>
