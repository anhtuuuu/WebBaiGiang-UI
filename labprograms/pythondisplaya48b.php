...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <p>Write a Python program to construct the stars(*) pattern, using a nested for loop  </p>
  <h2>Source Code: </h2>
  <h3>week10.py</h3>
<pre><code class="language-py"><code><span style="color: #000000">
'''Write&nbsp;a&nbsp;Python&nbsp;program&nbsp;to&nbsp;construct&nbsp;the&nbsp;following&nbsp;pattern,&nbsp;using&nbsp;a&nbsp;nested&nbsp;for&nbsp;loop<br />*<br />*&nbsp;*<br />*&nbsp;*&nbsp;*<br />*&nbsp;*&nbsp;*&nbsp;*<br />*&nbsp;*&nbsp;*&nbsp;*&nbsp;*<br />*&nbsp;*&nbsp;*&nbsp;*<br />*&nbsp;*&nbsp;*&nbsp;<br />*&nbsp;*<br />*<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'''<br />n=5;<br />for&nbsp;i&nbsp;in&nbsp;range(n):<br />&nbsp;&nbsp;&nbsp;&nbsp;for&nbsp;j&nbsp;in&nbsp;range(i):<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;print&nbsp;('*&nbsp;',&nbsp;end="")<br />&nbsp;&nbsp;&nbsp;&nbsp;print('')<br /><br />for&nbsp;i&nbsp;in&nbsp;range(n,0,-1):<br />&nbsp;&nbsp;&nbsp;&nbsp;for&nbsp;j&nbsp;in&nbsp;range(i):<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;print('*&nbsp;',&nbsp;end="")<br />&nbsp;&nbsp;&nbsp;&nbsp;print('')<br /></span>
</code></code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="python/outputs/w10.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
