...
<!-- Mirrored from studyglance.in/labprograms/dsdisplay.php?url1=ds/stacksll.c&url2=&url3=&url4=&title=Write%20a%20program%20that%20implement%20Stack%20(its%20operations)%20using%20Pointers%20%20%20&opurl1=ds/outputs/stackpa.png&opurl2=ds/outputs/stackpb.png&opurl3=&opurl4= by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:51:13 GMT -->
...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <p>Write a program that implement Stack (its operations) using Pointers   </p>
  <h2>Source Code: </h2>
  <h3>stacksll.c</h3>
<pre><code class="language-c"><code><span style="color: #000000">
#include&lt;stdio.h&gt;<br />#include&lt;conio.h&gt;<br />#include&lt;stdlib.h&gt;<br /><br />#define&nbsp;MAX&nbsp;50<br />int&nbsp;size;<br />//&nbsp;Defining&nbsp;the&nbsp;stack&nbsp;structure<br />struct&nbsp;stack&nbsp;{<br />int&nbsp;arr[MAX];<br />int&nbsp;top;<br />};<br />//&nbsp;Initializing&nbsp;the&nbsp;stack(i.e.,&nbsp;top=-1)<br />void&nbsp;init_stk(struct&nbsp;stack&nbsp;*st)&nbsp;{<br />st-&gt;top&nbsp;=&nbsp;-1;<br />}<br />//&nbsp;Entering&nbsp;the&nbsp;elements&nbsp;into&nbsp;stack<br />void&nbsp;push(struct&nbsp;stack&nbsp;*st,&nbsp;int&nbsp;num)&nbsp;{<br />if&nbsp;(st-&gt;top&nbsp;==&nbsp;size&nbsp;-&nbsp;1)&nbsp;{<br />printf("\nStack&nbsp;overflow(i.e.,&nbsp;stack&nbsp;full).");<br />return;<br />}<br />st-&gt;top++;<br />st-&gt;arr[st-&gt;top]&nbsp;=&nbsp;num;<br />}<br />//Deleting&nbsp;an&nbsp;element&nbsp;from&nbsp;the&nbsp;stack.<br />int&nbsp;pop(struct&nbsp;stack&nbsp;*st)&nbsp;{<br />int&nbsp;num;<br />if&nbsp;(st-&gt;top&nbsp;==&nbsp;-1)&nbsp;{<br />printf("\nStack&nbsp;underflow(i.e.,&nbsp;stack&nbsp;empty).");<br />return&nbsp;NULL;<br />}<br />num&nbsp;=&nbsp;st-&gt;arr[st-&gt;top];<br />st-&gt;top--;<br />return&nbsp;num;<br />}<br />void&nbsp;display(struct&nbsp;stack&nbsp;*st)&nbsp;{<br />int&nbsp;i;<br />for&nbsp;(i&nbsp;=&nbsp;st-&gt;top;&nbsp;i&nbsp;&gt;=&nbsp;0;&nbsp;i--)<br />printf("\n%d",&nbsp;st-&gt;arr[i]);<br />}<br />int&nbsp;main()&nbsp;{<br />int&nbsp;element,&nbsp;opt,&nbsp;val;<br />struct&nbsp;stack&nbsp;ptr;<br />init_stk(&amp;ptr);<br />printf("\nEnter&nbsp;Stack&nbsp;Size&nbsp;:");<br />scanf("%d",&nbsp;&amp;size);<br />while&nbsp;(1)&nbsp;{<br />printf("\n\nSTACK&nbsp;PRIMITIVE&nbsp;OPERATIONS");<br />printf("\n1.PUSH");<br />printf("\n2.POP");<br />printf("\n3.DISPLAY");<br />printf("\n4.QUIT");<br />printf("\n");<br />printf("\nEnter&nbsp;your&nbsp;option&nbsp;:&nbsp;");<br />scanf("%d",&nbsp;&amp;opt);<br />switch&nbsp;(opt)&nbsp;{<br />case&nbsp;1:<br />printf("\nEnter&nbsp;the&nbsp;element&nbsp;into&nbsp;stack:");<br />scanf("%d",&nbsp;&amp;val);<br />push(&amp;ptr,&nbsp;val);<br />break;<br />case&nbsp;2:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;element&nbsp;=&nbsp;pop(&amp;ptr);<br />printf("\nThe&nbsp;element&nbsp;popped&nbsp;from&nbsp;stack&nbsp;is&nbsp;:&nbsp;%d",&nbsp;element);<br />break;<br />case&nbsp;3:<br />printf("\nThe&nbsp;current&nbsp;stack&nbsp;elements&nbsp;are:");<br />display(&amp;ptr);<br />break;<br />case&nbsp;4:<br />exit(0);<br />default:<br />printf("\nEnter&nbsp;correct&nbsp;option!Try&nbsp;again.");<br />}<br />}<br />return&nbsp;(0);<br />}</span>
</code></code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="ds/outputs/stackpa.png" alt="image" class="img-rounded img-responsive"/><br/>
<img src="ds/outputs/stackpb.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
