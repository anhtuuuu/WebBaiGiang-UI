...
<!-- Mirrored from studyglance.in/labprograms/dmdisplay.php?url1=dm/fileformatsweka.html&title=Various%20File%20Formats%20supported%20by%20WEKA.%20And%20Study%20the%20ARFF%20file%20format. by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:49:07 GMT -->
...
<h2>Aim: </h2>
  <h1 style="font-size:18px;color:black;"><span style='font-size:25px;color:#ff3333;'>&#9755;</span> &nbsp;Various File Formats supported by WEKA. And Study the ARFF file format. </h1>
  <h2>Solution : </h2>	
...
<html lang="en">
 <head>
  ...
  <title>Various File Formats supported by WEKA </title>
   <style>
  p {
  color:black;
  }
 ...
 <body>
     <h1>Various File Formats supported by WEKA :</h1>
<p>In order to work with Weka Explorer, it is essential to <strong>load the data</strong> into the application. The data may in different formats such as CSV, Text, JSON and so on. 
<br/>
<br/>
WEKA supports a <strong>wide range of file formats</strong> to load the data.
</p><br>
<p>The following is the complete list of file formats</p>
<p>

<span style='font-size:20px;'>&#9755;</span>	Arff data files(*.arff)<br>
<span style='font-size:20px;'>&#9755;</span>	Arff data files(*arff.gz)<br>
<span style='font-size:20px;'>&#9755;</span>	C4.5 data files(*.names)<br>
<span style='font-size:20px;'>&#9755;</span>	C4.5 ata files(*.data)<br>
<span style='font-size:20px;'>&#9755;</span>	CSV data files(*.csv)<br>
<span style='font-size:20px;'>&#9755;</span>	JSON instance files(*.json)<br>
<span style='font-size:20px;'>&#9755;</span>	JSON instance files(*.json.gz)<br>
<span style='font-size:20px;'>&#9755;</span>	libsvm data files(*.libsvm)<br>
<span style='font-size:20px;'>&#9755;</span>	Matlab ASCII files(*.m)<br>
<span style='font-size:20px;'>&#9755;</span>	svm light data files(*.dat)<br>
<span style='font-size:20px;'>&#9755;</span>	Binary Serialized instances(*.bsi)<br>
<span style='font-size:20px;'>&#9755;</span>	XRFF data files(*.xrff)<br>
<span style='font-size:20px;'>&#9755;</span>	XRFF data files(*.xrff.gz)<br>


</p>
<br>
<p>The following screen displays all supported file formats in dropdown list at the bottom of window.</p><br>
	<div class="row"> 
		<div class="col-md-12">
		<img src="dm/images/Weka40.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
		<div class="col-md-4">	
		&nbsp;
		</div>
...
<p>As we see the WEKA supports various formats of data to load, among those formats the most commonly used data formats are <strong>Arff data files(*.arff)</strong> and <strong>CSV data files(*.csv)</strong>.<br><br>
<strong><span style='font-size:25px;'>&#9997;</span><u>NOTE : </u></strong>The default data format of WEKA is <strong>Arff data files (*.arff)</strong>.
</p>
<hr>
<h1>Study the ARFF file format:</h1><br>
<p>
    An ARFF (<strong>Attribute-Relation File Format</strong>) file is an ASCII text file that describes a list of instances sharing a set of attributes.<br><br>
    
The ARFF file format has mainly <strong>two sections</strong>, those are<br><br>
•	<strong>Header</strong> section<br><br>
•	<strong>Data</strong> section
<br>
</p>
<h2><font color="#000099">Header section:</font></h2>
<p>The Header section of the ARFF file contains the <strong>name of the relation</strong>, a <strong>list of the attributes</strong> and their <strong>types</strong>.</p>
<h3>@RELATION Declaration</h3>
<p>The relation name is defined as the first line in the ARFF file. </p>
<h4>format:</h4> 
<p>&nbsp;&nbsp;@RELATION &lt;relation-name&gt;<br><br>
-	where &lt;relation-name&gt; is a string. The relation name must be quoted if the name includes spaces.</p>
<h3>@ATTRIBUTE Declaration</h3>
<p>The attribute specifies name of the attribute along with type.</p>
<h4>format:</h4>
<p>&nbsp;&nbsp;	@ATTRIBUTE &lt;attribute-name&gt; &lt;datatype&gt;<br><br>
-  where the &lt;attribute-name&gt; must start with an alphabet. The attribute name must be quoted if the name includes spaces.<br><br>
</p>
<h4>Weka supports the following four datatypes:</h4>
<h3>1. Numeric attributes:</h3>
<p>Numeric attributes can be real or integer numbers.</p>

<h3>2. Nominal attributes:</h3>
<p>Nominal values are defined by providing the possible values: { nominal-value1, nominal-value2, nominal-value3,… }</p>

<h3>3. String attributes:</h3>
<p>String attributes allow us to define attributes holding textual values.</p>

<h3>4. Date attributes:</h3>
<p>Date attribute defined as follows <br><br>
&nbsp;&nbsp;@ATTRIBUTE &lt;name&gt; date [&lt;date-format&gt;] <br><br>
- where &lt;name&gt; is the name for the attribute and &lt;date-format&gt; is an optional string. The default date-format string is yyyy-MM-dd’T’HH:mm:ss.</p>
<br>
<strong>Example of Header Section:</strong><br><br>
<pre>
...
<br>
<p>In the above example, <br><br>
-	The lines which start with <strong>%</strong> are treated as comments.<br><br>
-	<strong>@RELATION</strong> specifies the name of the relation.<br><br>
-	<strong>@ATTRIBUTE</strong> specifies name of the attribute along with type and possible values.
</p>
<h2><font color="#000099">Data section:</font></h2>
<p>The Data section of the ARFF file contains the <strong>list of data values (instance data)</strong> separated by comma.</p>
<br>
<strong>Example of Body Section:</strong><br><br>
<pre>
   @DATA
   101,20,male
   102,19,female
...
<br>
<p>In the above, there are 3 instances with numeric and nominal values. And the symbol ? indicates missing values.<br><br>
<strong><span style='font-size:25px;'>&#9997;</span><u>NOTE : </u></strong> The <strong>@RELATION, @ATTRIBUTE</strong> and <strong>@DATA</strong> declarations are <strong>case insensitive</strong>. i.e @RELATION and @relation are treated as same in ARFF file format.<br><br>

The following is the <strong>complete ARFF file</strong></p><br>
<h3><u>Filename:</u> student. arff</h3><br>
	<div class="row"> 
		<div class="col-md-12">
		<img src="dm/images/Weka41.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
		<div class="col-md-4">	
		&nbsp;
		</div>
...
<!-- Mirrored from studyglance.in/labprograms/dmdisplay.php?url1=dm/fileformatsweka.html&title=Various%20File%20Formats%20supported%20by%20WEKA.%20And%20Study%20the%20ARFF%20file%20format. by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:49:08 GMT -->
</html>
