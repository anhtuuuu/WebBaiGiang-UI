...
<h1>Write a program that declares Class awarded for a given percentage of marks, where mark &lt;40%= Failed, 40% to &lt;60% = Second class, 60% to &lt;70%=First class, >= 70% = Distinction.Read percentage from standard input.</h1>

<div class="row"> 
<div class="col-md-12">
<div class="alert alert-info"><b>Algorithm</b> <pre><code class="language-algorithm">
start
	step1: Read percentage
	step2: if (percentage &gt; 100 OR percentage &lt; 0) then
	step3:  Print "You have entered wrong percentage"
	step4: else if (percentage &lt; 40) then
	step5: 	Print "Failed"
	step6: else if (percentage &gt;= 40 && percentage &lt; 60) then
	step7: 	Print "Second Class"
	step8: else if (percentage &gt;= 60 && percentage &lt; 70) then
	step9:  Print "First Class"
	step10: else Print "Distinction"
stop
</code></pre>
</div></div></div>
<br>
...
<img src="PPS/images/Class-awarded.jpg" width="100%" alt="flowchart for declares Class awarded for a given percentage in c">
</pre>
</div>
</div></div>
<br>
...
<div class="row"> 
<div class="col-md-12">
<div class="alert alert-info"><b>C Programming</b> <pre><code class="language-c">/* declares the class awarded for a given percentage of marks, where the marks:
&lt;40% = Failed,
...
<div class="row"> 
<div class="col-md-12">
<div class="alert alert-warning"><b>OUTPUT</b><pre><code class="language-c">Enter percentage of marks : 69.5
First Class</code></pre>
</div></div></div><!--
...
<!-- Mirrored from studyglance.in/labprograms/ppsdisplay.php?url1=PPS/declares-Class-awarded-c-program.html&title=Write%20a%20program%20that%20declares%20Class%20awarded%20for%20a%20given%20percentage%20of%20marks,%20where%20mark%20<40%=%20Failed,%2040%%20to%20<60%%20=%20Second%20class,%2060%%20to%20<70%=First%20class,%20>=%2070%%20=%20Distinction.Read%20percentage%20from%20standard%20input. by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:48:00 GMT -->
</html>
