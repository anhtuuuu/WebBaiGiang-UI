...
<!-- Mirrored from studyglance.in/labprograms/dmdisplay.php?url1=dm/weatherdataset.html&title=Demonstration%20of%20creating%20a%20Weather%20dataset%20(weather.arff)%20using%20WEKA%20tool%20in%20Data%20Mining by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:49:10 GMT -->
...
<h2>Aim: </h2>
  <h1 style="font-size:18px;color:black;"><span style='font-size:25px;color:#ff3333;'>&#9755;</span> &nbsp;Demonstration of creating a Weather dataset (weather.arff) using WEKA tool in Data Mining </h1>
  <h2>Solution : </h2>	
...
<html lang="en">
 <head>
  ...
  <title>Creating a weather dataset </title>
  <style>
  p {
  color:black;
  }
 ...
 <body>
 <h1>Creating a weather dataset (weather.arff):</h1>
 <h3> Description: </h3>
 <p>We need to create a Weather dataset with the data instances which includes attributes like temperature, humidity, windy, outlook, play.
 <br/></p>
 <br/>
...
<p>7) Explorer shows many options. In that click on <strong>'Open file...'</strong> button and select the <strong>.arff file</strong> (e.g. weather.arff).</p><br>
<div class="row"> 
		<div class="col-md-12">
		<img src="dm/images/Weka62.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
		<div class="col-md-4">	
		&nbsp;
		</div>
	</div><br>
<p> 8) Click on <strong>edit </strong>button which shows weather table on weka.</p><br>
<div class="row"> 
		<div class="col-md-12">
		<img src="dm/images/Weka63.png" style="border-radius:10px;" class="img-rounded img-responsive"></img>
		</div>
		<div class="col-md-4">	
		&nbsp;
		</div>
...
<h3> Result:</h3><br>
<p> The <strong>weather dataset</strong> (weather.arff) was created successfully using WEKA tool kit.</p>

 </body>

<!-- Mirrored from studyglance.in/labprograms/dmdisplay.php?url1=dm/weatherdataset.html&title=Demonstration%20of%20creating%20a%20Weather%20dataset%20(weather.arff)%20using%20WEKA%20tool%20in%20Data%20Mining by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:49:11 GMT -->
</html>
