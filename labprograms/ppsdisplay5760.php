...
<!-- Mirrored from studyglance.in/labprograms/ppsdisplay.php?url1=PPS/position-of-a-character-c-program.html&title=Write%20a%20C%20program%20that%20displays%20the%20position%20of%20a%20character%20ch%20in%20the%20string%20S%20or%20%e2%80%93%201%20if%20S%20doesn%e2%80%98t%20contain%20ch by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:48:29 GMT -->
...
<h1>Write a C program that displays the position of a character ch in the string S or – 1 if S doesn‘t contain ch.</h1>

<div class="row"> 
<div class="col-md-12">
<div class="alert alert-info"><b>C Program</b> <pre><code class="language-c">//position of a character ch in the string S or – 1 if S doesn‘t contain ch.
#include &lt;stdio.h>
#include &lt;string.h>
...
<div class="row"> 
<div class="col-md-12">
<div class="alert alert-warning"><b>OUTPUT</b><pre><code class="language-c">Enter the string: studyglance
Enter the character to find: g
Position of 'g' in string: 5</code></pre>
</div></div></div>
<!--
