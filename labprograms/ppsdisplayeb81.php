...
<!-- Mirrored from studyglance.in/labprograms/ppsdisplay.php?url1=PPS/velocity-c-program.html&title=A%20building%20has%2010%20floors%20with%20a%20floor%20height%20of%203%20meters%20each.%20A%20ball%20is%20dropped%20from%20the%20top%20of%20the%20building.%20Find%20the%20time%20taken%20by%20the%20ball%20to%20reach%20each%20floor.%20(Use%20the%20formula%20s%20=%20ut+(1/2)at^2where%20u%20and%20a%20are%20the%20initial%20velocity%20in%20m/sec%20(=%200)%20and%20acceleration%20in%20m/sec^2%20(=%209.8%20m/s^2)). by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:48:07 GMT -->
...
<h1>A building has 10 floors with a floor height of 3 meters each. A ball is dropped from the top of the building. Find the time taken by the ball to reach each floor. (Use the formula s = ut+(1/2)at^2where u and a are the initial velocity in m/sec (= 0) and acceleration in m/sec^2 (= 9.8 m/s^2)).</h1>
...
start
	...
	step4: 	s := h * i
	step5: 	time := &#8730;<SPAN STYLE="text-decoration:overline">((2*s)/a)</SPAN>
	step6: Print time
stop
</code></pre>
</div></div></div>
...
<img src="PPS/images/velocity.jpg" width="60%" alt="flowchart for s = ut+(1/2)at^2 in c">
</pre>
</div>
</div></div>
<br>
...
<div class="row"> 
<div class="col-md-12">
<div class="alert alert-info"><b>C Programming</b> <pre><code class="language-c">//Use the formula s = ut+(1/2)at^2 where u and a are the initial velocity in m/sec (= 0) and acceleration in m/sec^2 (= 9.8 m/s^2).
#include &lt;stdio.h>
#include &lt;math.h>
...
<div class="row"> 
<div class="col-md-12">
<div class="alert alert-warning"><b>OUTPUT</b><pre><code class="language-c">floors: 10
height of each floor: 3
floor 1: 0.78 seconds
floor 2: 1.11 seconds
floor 3: 1.36 seconds
floor 4: 1.56 seconds
floor 5: 1.75 seconds
floor 6: 1.92 seconds
floor 7: 2.07 seconds
floor 8: 2.21 seconds
floor 9: 2.35 seconds
floor 10: 2.47 seconds</code></pre>
</div></div></div><!--
...
<!-- Mirrored from studyglance.in/labprograms/ppsdisplay.php?url1=PPS/velocity-c-program.html&title=A%20building%20has%2010%20floors%20with%20a%20floor%20height%20of%203%20meters%20each.%20A%20ball%20is%20dropped%20from%20the%20top%20of%20the%20building.%20Find%20the%20time%20taken%20by%20the%20ball%20to%20reach%20each%20floor.%20(Use%20the%20formula%20s%20=%20ut+(1/2)at^2where%20u%20and%20a%20are%20the%20initial%20velocity%20in%20m/sec%20(=%200)%20and%20acceleration%20in%20m/sec^2%20(=%209.8%20m/s^2)). by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:48:10 GMT -->
</html>
