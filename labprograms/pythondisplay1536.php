...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <p>Write a Python class to convert an integer to a roman numeral. </p>
  <h2>Source Code: </h2>
  <h3>week18.py</h3>
<pre><code class="language-py"><code><span style="color: #000000">
'''Write&nbsp;a&nbsp;Python&nbsp;class&nbsp;to&nbsp;convert&nbsp;an&nbsp;integer&nbsp;to&nbsp;a&nbsp;roman&nbsp;numeral.'''<br /><br />class&nbsp;irconvert:<br />&nbsp;&nbsp;&nbsp;&nbsp;num_map&nbsp;=&nbsp;[(1000,&nbsp;'M'),&nbsp;(900,&nbsp;'CM'),&nbsp;(500,&nbsp;'D'),&nbsp;(400,&nbsp;'CD'),&nbsp;(100,&nbsp;'C'),&nbsp;(90,&nbsp;'XC'),(50,&nbsp;'L'),&nbsp;(40,&nbsp;'XL'),&nbsp;(10,&nbsp;'X'),&nbsp;(9,&nbsp;'IX'),&nbsp;(5,&nbsp;'V'),&nbsp;(4,&nbsp;'IV'),&nbsp;(1,&nbsp;'I')]<br />&nbsp;&nbsp;&nbsp;&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;def&nbsp;num2roman(self,num):<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;roman&nbsp;=&nbsp;''<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;while&nbsp;num&nbsp;&gt;&nbsp;0:<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for&nbsp;i,&nbsp;r&nbsp;in&nbsp;self.num_map:<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;while&nbsp;num&nbsp;&gt;=&nbsp;i:<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;roman&nbsp;+=&nbsp;r<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;num&nbsp;-=&nbsp;i<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return&nbsp;roman<br /><br /><br />num=int(input("Enter&nbsp;any&nbsp;Number&nbsp;:"))<br />print("Roman&nbsp;Number&nbsp;is&nbsp;:&nbsp;",irconvert().num2roman(num))<br /></span>
</code></code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="python/outputs/w18.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
...
<!-- Mirrored from studyglance.in/labprograms/pythondisplay.php?url1=python/week18.py&url2=&url3=&url4=&title=Write%20a%20Python%20class%20to%20convert%20an%20integer%20to%20a%20roman%20numeral.&opurl1=python/outputs/w18.png&opurl2=&opurl3=&opurl4= by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:50:49 GMT -->
</html>
