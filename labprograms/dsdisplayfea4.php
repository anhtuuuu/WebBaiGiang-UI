...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <p>Write a program that implements Bubble Sort Method to sort a given list of integers in ascending order.</p>
  <h2>Source Code: </h2>
  <h3>Bubblesort.c</h3>
<pre><code class="language-c"><code><span style="color: #000000">
#include&lt;stdio.h&gt;<br />bubblesort(int&nbsp;a[],int&nbsp;n)<br />{<br />int&nbsp;temp,p,c;<br />for(p=1;p&lt;=n-1;p++)<br />{<br />for(c=1;c&lt;=n-p;c++)<br />{<br />if(a[c]&gt;a[c+1])<br />{<br />temp=a[c];<br />a[c]=a[c+1];<br />a[c+1]=temp;<br />}&nbsp;<br />}&nbsp;<br />}&nbsp;<br />}<br /><br />int&nbsp;main()<br />{<br />int&nbsp;a[5],n,i;<br />printf("enter&nbsp;n&nbsp;value");<br />scanf("%d",&amp;n);<br />printf("enter&nbsp;%d&nbsp;elements&nbsp;into&nbsp;array",n);<br />for(i=1;i&lt;=n;i++)<br />scanf("%d",&amp;a[i]);<br />bubblesort(a,n);<br />printf("after&nbsp;sauting&nbsp;elements&nbsp;are");<br />for(i=1;i&lt;=n;i++)<br />printf("%d\t",a[i]);<br />return&nbsp;1;<br />}<br /></span>
</code></code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="ds/outputs/bsort.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
