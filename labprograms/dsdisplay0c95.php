...
<!-- Mirrored from studyglance.in/labprograms/dsdisplay.php?url1=ds/nonrecursive-binarysearch.c&url2=ds/recursive-binarysearch.c&url3=&url4=&title=Write%20a%20program%20that%20use%20both%20recursive%20and%20non%20recursive%20functions%20to%20perform%20Binary%20search%20operations%20for%20a%20Key%20value%20in%20a%20given%20list%20of%20integers.&opurl1=ds/outputs/nrbs.png&opurl2=ds/outputs/rbs.png&opurl3=&opurl4= by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:51:17 GMT -->
...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <p>Write a program that use both recursive and non recursive functions to perform Binary search operations for a Key value in a given list of integers.</p>
  <h2>Source Code: </h2>
  <h3>nonrecursive-binarysearch.c</h3>
<pre><code class="language-c"><code><span style="color: #000000">
#include&nbsp;&lt;stdio.h&gt;<br />int&nbsp;binarysearch(int&nbsp;a[],int&nbsp;low,int&nbsp;high,int&nbsp;key)<br />{<br />int&nbsp;mid;<br />while(low&lt;=high)<br />{<br />mid=(low+high)/2;<br />if(a[mid]==key)<br />{<br />return&nbsp;mid;<br />}<br />else&nbsp;if(key&gt;a[mid])<br />{<br />low=mid+1;<br />}<br />else&nbsp;if(key&lt;a[mid])<br />high=mid-1;<br />}<br />return&nbsp;-1;<br />}<br /><br />int&nbsp;main()<br />{<br />int&nbsp;a[20],i,n,key,pos;<br /><br />printf("enter&nbsp;n&nbsp;value");<br />scanf("%d",&amp;n);<br />printf("enter&nbsp;%d&nbsp;elements",n);<br />for(i=0;i&lt;n;i++)<br />{<br />scanf("%d",&amp;a[i]);<br />}<br />printf("enter&nbsp;the&nbsp;key&nbsp;element");<br />scanf("%d",&amp;key);<br />pos=binarysearch(a,0,n-1,key);<br />if(pos&gt;=0)<br />{<br />printf("element&nbsp;is&nbsp;found&nbsp;at&nbsp;%d",pos+1);<br />}<br />else<br />{<br />printf("element&nbsp;is&nbsp;not&nbsp;found");<br />}<br />getch();<br />}</span>
</code></code></pre><br>
 <h3>recursive-binarysearch.c</h3>
<pre><code class="language-c"><code><span style="color: #000000">
#include&lt;stdio.h&gt;<br />#include&lt;stdlib.h&gt;<br />#define&nbsp;size&nbsp;10<br />int&nbsp;binsearch(int[],&nbsp;int,&nbsp;int,&nbsp;int);<br />int&nbsp;main()&nbsp;{<br />int&nbsp;num,&nbsp;i,&nbsp;key,&nbsp;position;<br />int&nbsp;low,&nbsp;high,&nbsp;list[size];<br />printf("\nEnter&nbsp;the&nbsp;total&nbsp;number&nbsp;of&nbsp;elements");<br />scanf("%d",&nbsp;&amp;num);<br />printf("\nEnter&nbsp;the&nbsp;elements&nbsp;of&nbsp;list&nbsp;:");<br />for&nbsp;(i&nbsp;=&nbsp;0;&nbsp;i&nbsp;&lt;&nbsp;num;&nbsp;i++)&nbsp;{<br />scanf("%d",&nbsp;&amp;list[i]);<br />}<br />low&nbsp;=&nbsp;0;<br />high&nbsp;=&nbsp;num&nbsp;-&nbsp;1;<br /><br />printf("\nEnter&nbsp;element&nbsp;to&nbsp;be&nbsp;searched&nbsp;:&nbsp;");<br />scanf("%d",&nbsp;&amp;key);<br />position&nbsp;=&nbsp;binsearch(list,&nbsp;key,&nbsp;low,&nbsp;high);<br />if&nbsp;(position&nbsp;!=&nbsp;-1)&nbsp;{<br />printf("\nNumber&nbsp;present&nbsp;at&nbsp;%d",&nbsp;(position&nbsp;+&nbsp;1));<br />}&nbsp;else<br />printf("\n&nbsp;The&nbsp;number&nbsp;is&nbsp;not&nbsp;present&nbsp;in&nbsp;the&nbsp;list");<br />return&nbsp;(0);<br />}<br />//&nbsp;Binary&nbsp;Search&nbsp;function<br />int&nbsp;binsearch(int&nbsp;a[],&nbsp;int&nbsp;x,&nbsp;int&nbsp;low,&nbsp;int&nbsp;high)&nbsp;{<br />int&nbsp;mid;<br />if&nbsp;(low&nbsp;&gt;&nbsp;high)<br />return&nbsp;-1;<br />mid&nbsp;=&nbsp;(low&nbsp;+&nbsp;high)&nbsp;/&nbsp;2;<br />if&nbsp;(x&nbsp;==&nbsp;a[mid])&nbsp;{<br />return&nbsp;(mid);<br />}&nbsp;else&nbsp;if&nbsp;(x&nbsp;&lt;&nbsp;a[mid])&nbsp;{<br />binsearch(a,&nbsp;x,&nbsp;low,&nbsp;mid&nbsp;-&nbsp;1);<br />}&nbsp;else&nbsp;{<br />binsearch(a,&nbsp;x,&nbsp;mid&nbsp;+&nbsp;1,&nbsp;high);<br />}<br />}</span>
</code></code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="ds/outputs/nrbs.png" alt="image" class="img-rounded img-responsive"/><br/>
<img src="ds/outputs/rbs.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
...
<!-- Mirrored from studyglance.in/labprograms/dsdisplay.php?url1=ds/nonrecursive-binarysearch.c&url2=ds/recursive-binarysearch.c&url3=&url4=&title=Write%20a%20program%20that%20use%20both%20recursive%20and%20non%20recursive%20functions%20to%20perform%20Binary%20search%20operations%20for%20a%20Key%20value%20in%20a%20given%20list%20of%20integers.&opurl1=ds/outputs/nrbs.png&opurl2=ds/outputs/rbs.png&opurl3=&opurl4= by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:51:18 GMT -->
</html>
