...
<!-- Mirrored from studyglance.in/labprograms/mldisplay.php?url1=ml/Week2.py&url2=&url3=&url4=&title=Extract%20the%20data%20from%20database%20using%20python&alg=&opurl1=ml/outputs/w21.PNG&opurl2=ml/outputs/w22.PNG&opurl3=&opurl4= by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:50:51 GMT -->
...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <h1 style="font-size:22px;color:black;">Extract the data from database using python</h1>
  <!--<h2> Explanation : </h2>
  <p></p>-->
  <h2>Source Code: </h2>
  <h3>Week2.py</h3>
<pre><code class="language-py">'''Aim:  Extract the data from database using python
...
-->
<h2>Output: </h2>
<img src="ml/outputs/w21.png" alt="image" class="img-rounded img-responsive"/><br/>
<img src="ml/outputs/w22.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
...
<!-- Mirrored from studyglance.in/labprograms/mldisplay.php?url1=ml/Week2.py&url2=&url3=&url4=&title=Extract%20the%20data%20from%20database%20using%20python&alg=&opurl1=ml/outputs/w21.PNG&opurl2=ml/outputs/w22.PNG&opurl3=&opurl4= by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:50:52 GMT -->
</html>
