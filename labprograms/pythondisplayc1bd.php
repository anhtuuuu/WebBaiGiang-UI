...
<!-- Mirrored from studyglance.in/labprograms/pythondisplay.php?url1=python/file1.txt&url2=python/week17.py&url3=&url4=&title=Write%20a%20program%20that%20inputs%20a%20text%20file.%20The%20program%20should%20print%20all%20of%20the%20unique%20words%20in%20the%20file%20in%20alphabetical%20order.&opurl1=python/outputs/w17.png&opurl2=&opurl3=&opurl4= by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:50:48 GMT -->
...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <p>Write a program that inputs a text file. The program should print all of the unique words in the file in alphabetical order. </p>
  <h2>Source Code: </h2>
  <h3>file1.txt</h3>
...
'''Write&nbsp;a&nbsp;program&nbsp;that&nbsp;inputs&nbsp;a&nbsp;text&nbsp;file.&nbsp;The&nbsp;program&nbsp;should&nbsp;print&nbsp;all&nbsp;of&nbsp;the&nbsp;unique<br />words&nbsp;in&nbsp;the&nbsp;file&nbsp;in&nbsp;alphabetical&nbsp;order'''<br />fname&nbsp;=&nbsp;input("Enter&nbsp;file&nbsp;name:&nbsp;")<br />fh&nbsp;=&nbsp;open(fname)<br />lst&nbsp;=&nbsp;list()&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#&nbsp;list&nbsp;for&nbsp;the&nbsp;desired&nbsp;output<br />words=[];<br />for&nbsp;line&nbsp;in&nbsp;fh:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#&nbsp;to&nbsp;read&nbsp;every&nbsp;line&nbsp;of&nbsp;file&nbsp;romeo.txt<br />&nbsp;&nbsp;&nbsp;&nbsp;words&nbsp;+=&nbsp;line.split()<br />words.sort()<br /><br />#&nbsp;display&nbsp;the&nbsp;sorted&nbsp;words<br /><br />print("The&nbsp;unique&nbsp;words&nbsp;in&nbsp;&nbsp;alphabetical&nbsp;order&nbsp;are:")<br />for&nbsp;word&nbsp;in&nbsp;words:<br />&nbsp;&nbsp;&nbsp;&nbsp;if&nbsp;word&nbsp;in&nbsp;lst:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#&nbsp;if&nbsp;element&nbsp;is&nbsp;repeated<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;continue&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#&nbsp;do&nbsp;nothing<br />&nbsp;&nbsp;&nbsp;&nbsp;else:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#&nbsp;else&nbsp;if&nbsp;element&nbsp;is&nbsp;not&nbsp;in&nbsp;the&nbsp;list<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lst.append(word)<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;print(word)<br />#print(lst)</span>
</code></code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="python/outputs/w17.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
