...
<!-- Mirrored from studyglance.in/labprograms/powerbidisplay.php?url1=powerbi/week5.html&title=Editing%20and%20Formatting%20Axes,%20Manipulating%20Data%20in%20Tableau%20data,%20Pivoting%20Tableau%20data. by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:50:23 GMT -->
...
<h2>Aim: </h2>
  <h1 style="font-size:18px;color:black;">Editing and Formatting Axes, Manipulating Data in Tableau data, Pivoting Tableau data. </h1>
  <h2>Solution : </h2>	
...
<html lang="en">
 <head>
  ...
  <meta name="Keywords" content="Editing and Formatting Axes, Manipulating Data in Tableau data, Pivoting Tableau data, Tableau">
  <meta name="Description" content="">
  <title>Editing and Formatting Axes, Manipulating Data in Tableau data, Pivoting Tableau data.</title>
 </head>
 <body>
<h1>Editing and Formatting Axes:</h1>
<div class="row"> 
	<div class="col-md-12">
...
<h2>1.	Edit Axis Title:</h2>
<ul>
	<li>Click on the axis title you want to edit.</li>
	<li>You can now modify the title text, font, size, color, and alignment using the Format pane or the toolbar at the top.</li>
</ul>
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w5-4.jpg" width="80%" style="border-radius:10px;"/>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
...
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w5-5.jpg" width="80%" style="border-radius:10px;"/>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
</div>
<h2>2.	Edit Axis Labels:</h2>
<ul>
	<li>Right-click on an axis and select "Edit Axis."</li>
	<li>In the Edit Axis dialog box, you can change the formatting of labels, tick marks, and other axis-related properties.</li>
</ul>
 
 
<h2>3.	Scale and Range:</h2>
<ul>
	<li>To change the scale or range of an axis, right-click on it and select "Edit Axis."</li>
	<li>In the dialog box, adjust the Minimum and Maximum values, scale, or range according to your needs.</li>
</ul>
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w5-6.jpg" width="80%" style="border-radius:10px;"/>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
...
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w5-7.jpg" width="80%" style="border-radius:10px;"/>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
...
<div class="row"> 
	<div class="col-md-6">
	<img src="powerbi/images/w5-8.jpg" width="80%" style="border-radius:10px;"/>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
...
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w5-9.jpg" width="80%" style="border-radius:10px;"/>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
</div><br>
<h1>Manipulating Data in Tableau data</h1>
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w5-10.jpg" width="80%" style="border-radius:10px;"/>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
...
<p>If Tableau has inferred a wrong data type for a column, the data type can be changed by clicking on the data type symbol in the column header</p>
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w5-11.jpg" width="80%" style="border-radius:10px;"/>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
</div><br>
<h2>New Column(Calculated Fields)</h2>
<p>Calculated fields can be used if you need to create customized logic for manipulating certain data types or data values. There are a large-range of functions available in Tableau that can used individually or collectively for data manipulation</p>
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w5-12.jpg" width="80%" style="border-radius:10px;"/>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
...
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w5-13.jpg" width="80%" style="border-radius:10px;"/>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
...
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w5-14.jpg" width="80%" style="border-radius:10px;"/>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
</div><br>
<h1>Pivoting Tableau data</h1>
<p>Data pivoting enables you to rearrange the columns and rows in a report so you can view data from different perspectives</p>
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w5-15.jpg" width="80%" style="border-radius:10px;"/>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
...
<!-- Mirrored from studyglance.in/labprograms/powerbidisplay.php?url1=powerbi/week5.html&title=Editing%20and%20Formatting%20Axes,%20Manipulating%20Data%20in%20Tableau%20data,%20Pivoting%20Tableau%20data. by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:50:41 GMT -->
</html>
