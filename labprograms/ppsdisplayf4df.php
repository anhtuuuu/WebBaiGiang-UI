...
<!-- Mirrored from studyglance.in/labprograms/ppsdisplay.php?url1=PPS/operators-c-program.html&title=Write%20a%20simple%20program%20that%20prints%20the%20results%20of%20all%20the%20operators%20available%20in%20C%20(including%20pre/%20post%20increment%20,%20bitwise%20and/or/not%20,%20etc.).%20Read%20required%20operand%20values%20from%20standard%20input by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:47:56 GMT -->
...
<h1>Write a simple program that prints the results of all the operators available in C (including pre/ post increment , bitwise and/or/not , etc.). Read required operand values from standard input</h1>

<div class="row"> 
<div class="col-md-12">
<div class="alert alert-info"><b>Algorithm</b> <pre><code class="language-algorithm">
start
	step1: read number1,number2
	step2: print number1
	step3: print number1++
	step4: print ++number1
	step5: print number1 AND number2
	step6: print number1 OR number2
	step7: print number1 XOR number2
	step8: print Inverts all the bits of number1
	step9: print number1 shift two bits left
	step10:print number1 shift two bits right
stop
</code></pre>
</div></div></div>
<br>
...
<img src="PPS/images/operators.jpg" width="40%" alt="flowchart for operators available in C">
</pre>
</div>
</div></div>
<br>
...
<div class="row"> 
<div class="col-md-12">
<div class="alert alert-info"><b>C Programming</b> <pre><code class="language-c">//The operators available in C like Increment and Decrement operators and Bitwise operators
#include &lt;stdio.h>
int main() {
    int number1,number2;
...
<div class="row"> 
<div class="col-md-12">
<div class="alert alert-warning"><b>OUTPUT</b><pre><code class="language-c">Enter two Integer: 20 30
Original Number: 20
After Post-increment: 20
After Pre-increment: 22
number1 & number2 = 22
number1 | b number2 = 30
number1 ^ b number2 = 8
~number1 = -23
number1 &lt;&lt; 2 = 88
number1 &gt;&gt; 2 = 5</code></pre>
</div></div></div><!--
