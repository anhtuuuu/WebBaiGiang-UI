...
<div class="panel panel-default">
 ...
 <!--<iframe src="https://docs.google.com/gview?url=http://localhost/studyglance/XML.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>-->
  ...
  <h2>Aim: </h2>
  <h1 style=" text-align: justify;"> Write a Java program that simulates a traffic light. The program lets the user selects one of three lights: red, yellow, or green with radio buttons. On selecting a button, an appropriate message with Stop, Ready, or Go should appear above the buttons in the selected color. Initially, there is no message shown </h1>
  <!--<h2> Algorithm </h2>
  <pre></pre>-->
  <h2>Source Code: </h2>
  <h3>TrafficLights.java</h3>
<pre><code class="language-java"><code><span style="color: #000000">
import&nbsp;java.awt.*;<br />import&nbsp;javax.swing.*;<br />import&nbsp;java.awt.event.*;<br />class&nbsp;TrafficLights&nbsp;extends&nbsp;JFrame&nbsp;implements&nbsp;ActionListener&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;JLabel&nbsp;lbl1,&nbsp;lbl2;<br />&nbsp;&nbsp;&nbsp;&nbsp;JRadioButton&nbsp;rl,gl,ol;<br />&nbsp;&nbsp;&nbsp;&nbsp;ButtonGroup&nbsp;bg;<br />&nbsp;&nbsp;&nbsp;&nbsp;TrafficLights()&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Font&nbsp;fontL&nbsp;=&nbsp;new&nbsp;Font("Verdana",&nbsp;Font.BOLD,&nbsp;70);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lbl1&nbsp;=&nbsp;new&nbsp;JLabel();<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lbl1.setBounds(170,30,300,200);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lbl1.setFont(fontL);&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;add(lbl1);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Font&nbsp;fontR&nbsp;=&nbsp;new&nbsp;Font("Verdana",&nbsp;Font.BOLD,&nbsp;16);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lbl2&nbsp;=&nbsp;new&nbsp;JLabel("Select&nbsp;Lights");<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lbl2.setBounds(20,250,130,50);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lbl2.setFont(fontR);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;add(lbl2);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;rl&nbsp;=&nbsp;new&nbsp;JRadioButton("Red&nbsp;Light");<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;rl.setBounds(160,250,120,50);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;rl.setBackground(Color.RED);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;rl.setFont(fontR);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;add(rl);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;rl.addActionListener(this);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ol&nbsp;=&nbsp;new&nbsp;JRadioButton("Orange&nbsp;Light");<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ol.setBounds(300,250,150,50);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ol.setBackground(Color.ORANGE);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ol.setFont(fontR);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;add(ol);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ol.addActionListener(this);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;gl&nbsp;=&nbsp;new&nbsp;JRadioButton("Green&nbsp;Light");<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;gl.setBounds(460,250,140,50);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;gl.setBackground(Color.GREEN);&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;gl.setFont(fontR);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;add(gl);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;gl.addActionListener(this);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;bg&nbsp;=&nbsp;new&nbsp;ButtonGroup();<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;bg.add(rl);bg.add(ol);bg.add(gl);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;setTitle("Traffic&nbsp;Light&nbsp;Simulator");<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;setSize(650,400);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;setLayout(null);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;setVisible(true);<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br />&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;To&nbsp;read&nbsp;selected&nbsp;item&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;public&nbsp;void&nbsp;actionPerformed(ActionEvent&nbsp;ae)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if(ae.getSource()&nbsp;==&nbsp;rl)<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lbl1.setText("STOP");<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lbl1.setForeground(Color.RED);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if(ae.getSource()&nbsp;==&nbsp;ol)<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lbl1.setText("READY");<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lbl1.setForeground(Color.ORANGE);&nbsp;&nbsp;&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;if(ae.getSource()&nbsp;==&nbsp;gl)<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lbl1.setText("GO");<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;lbl1.setForeground(Color.GREEN);<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br />&nbsp;&nbsp;&nbsp;&nbsp;//&nbsp;main&nbsp;method<br />&nbsp;&nbsp;&nbsp;&nbsp;public&nbsp;static&nbsp;void&nbsp;main(String[]&nbsp;args)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;new&nbsp;TrafficLights();<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br />}</span>
</code></code></pre><br>
<!--<br />
...
-->
<h2>Output: </h2>
<img src="java/outputs/w71.png" alt="image" class="img-rounded img-responsive"/><br/>
<img src="java/outputs/w72.png" alt="image" class="img-rounded img-responsive"/><br/>
<img src="java/outputs/w73.png" alt="image" class="img-rounded img-responsive"/><br/>
<img src="java/outputs/w74.png" alt="image" class="img-rounded img-responsive"/><br/>
<img src="java/outputs/w75.png" alt="image" class="img-rounded img-responsive"/><br/>
<!--<br />
...
<!-- Mirrored from studyglance.in/labprograms/javadisplay.php?url1=java/TrafficLights.java&url2=&url3=&url4=&title=Write%20a%20Java%20program%20that%20simulates%20a%20traffic%20light.%20The%20program%20lets%20the%20user%20selects%20one%20of%20three%20lights:%20red,%20yellow,%20or%20green%20with%20radio%20buttons.%20On%20selecting%20a%20button,%20an%20appropriate%20message%20with%20Stop,%20Ready,%20or%20Go%20should%20appear%20above%20the%20buttons%20in%20the%20selected%20color.%20Initially,%20there%20is%20no%20message%20shown&alg=&opurl1=java/outputs/w71.png&opurl2=java/outputs/w72.png&opurl3=java/outputs/w73.png&opurl4=java/outputs/w74.png&opurl5=java/outputs/w75.png by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:48:37 GMT -->
</html>
