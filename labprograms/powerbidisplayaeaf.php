...
<!-- Mirrored from studyglance.in/labprograms/powerbidisplay.php?url1=powerbi/week2.html&title=%20Getting%20started%20with%20Tableau%20Software%20using%20Data%20file%20formats,%20connecting%20your%20Data%20to%20Tableau,creating%20basic%20charts(line,%20bar%20charts,%20Tree%20maps),Using%20the%20Show%20me%20panel. by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:49:18 GMT -->
...
<h2>Aim: </h2>
  <h1 style="font-size:18px;color:black;"> Getting started with Tableau Software using Data file formats, connecting your Data to Tableau,creating basic charts(line, bar charts, Tree maps),Using the Show me panel. </h1>
  <h2>Solution : </h2>	
...
<p>Getting started with Tableau software is a great way to create data visualizations quickly and efficiently. Here are the steps to get started, including connecting your data to Tableau, creating basic charts like line charts, bar charts, and treemaps, and using the Show Me panel:</p><br>
<h1>1. Download and Install Tableau:</h1>
<p>First, you'll need to download and install <strong>Tableau Desktop</strong> or <strong>Tableau Public</strong> (a free version). Follow the installation instructions provided on the Tableau website for your specific operating system.</p>
<h1>2. Prepare Your Data:</h1>
<p>Before connecting your data to Tableau, ensure that your data is in a suitable format. Common data file formats that Tableau supports include <strong>Excel (.xlsx), CSV (.csv), and text files (.txt)</strong>. Make sure your data is organized with headers for each column.</p>
<h1>3. Connect Your Data to Tableau:</h1>
<p>3.1 Launch <strong>Tableau Desktop.</strong></p><br>
<p>3.2 Go to "<strong>File</strong>" Menu and then click on  "<strong>Open</strong>".</p>
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w2-open.jpg" width="90%" style="border-radius:10px;"></img>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
</div>
<p>3.3 Choose the data source type (e.g., Excel, CSV, text file) and Select the data file(<strong>P6-SuperStoreUS-2015.xls</strong>) and click "Open".</p><br>
<p>3.4 Drag any table(e.g. Orders) into working area.</p><br>
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w2-open1.jpg" width="90%" style="border-radius:10px;"></img>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
</div>
<p>3.5 Click on Worksheet(<strong>Sheet1</strong>).</p><br>
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w2-open2.jpg" width="90%" style="border-radius:10px;"></img>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
...
<h1>4. Data Source Pane:</h1>
<p>Once your data is connected, the Data Source Pane will appear on the left-hand side of the Tableau interface. Here, you can see a preview of your data and perform data transformations or join multiple data sources if necessary.</p>
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w2-open3.jpg" width="90%" style="border-radius:10px;"></img>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
...
<h1>5. Creating Basic Charts:</h1>
<p>Now, let's create some basic charts using Tableau:</p>
<h2>a. Line Chart:</h2>
<p>1.	From the "<strong>Data Source pane</strong>", drag and drop the <u>date field</u> to the <strong>Columns shelf</strong> and a <u>numeric field</u> (e.g., sales, revenue) to the <strong>Rows shelf</strong>.</p>
 <div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w2-open4.jpg" width="90%" style="border-radius:10px;"></img>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
...
<br>
<p>2.	Then <strong>Tableau</strong> will automatically create a line chart. You can customize it by adding <u><em>labels, titles, and formatting</em></u>.</p>
 <div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w2-open5.jpg" width="90%" style="border-radius:10px;"></img>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
...
<h2>b. Bar Chart:</h2>
<p>1.	Drag and drop a <strong>categorical field</strong> (e.g., product category, region) to the Columns shelf and a <strong>numeric field</strong> to the Rows shelf.</p>
  <div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w2-open6.jpg" width="90%" style="border-radius:10px;"></img>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
...
<br>
<p>2.	Then <strong>Tableau</strong> will create a bar chart. You can adjust the orientation and formatting as needed. To display Labels on the bars click on Lables and select "<strong>Show mark lables</strong>" </p><br>
<div class="row"> 
	<div class="col-md-12">
	<img src="powerbi/images/w2-open7.jpg" width="90%" style="border-radius:10px;"></img>
	</div>
	<div class="col-md-4">	
	&nbsp;
	</div>
...
<br>
<h2>c. Treemap:</h2>
<p>1.	Drag and drop a categorical field to the Columns shelf.</p>
<p>2.	Drag and drop a numeric field to the Size shelf.</p>
<p>3.	Tableau will create a treemap visualization. You can further customize it by adjusting colors and labels.</p>
 

<h1>6. Using the Show Me Panel:</h1>
<p>The Show Me panel in Tableau helps you explore various chart types based on your data and the fields you select. Here's how to use it:</p>
<p>1.	After adding fields to the Rows and Columns shelves, click on the "Show Me" panel located on the left side of the Tableau interface.</p>
 
<p>2.	In the Show Me panel, you'll see a variety of chart options that Tableau recommends based on your data. Click on a chart type to create it.</p>
 
<p>3.	Tableau will automatically generate the selected chart type with your data. You can further customize it as needed.</p>
<p>4.	To go back to the regular worksheet view, click the "Clear" button in the Show Me panel.</p>

 </body>

<!-- Mirrored from studyglance.in/labprograms/powerbidisplay.php?url1=powerbi/week2.html&title=%20Getting%20started%20with%20Tableau%20Software%20using%20Data%20file%20formats,%20connecting%20your%20Data%20to%20Tableau,creating%20basic%20charts(line,%20bar%20charts,%20Tree%20maps),Using%20the%20Show%20me%20panel. by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 28 May 2025 03:49:23 GMT -->
</html>
